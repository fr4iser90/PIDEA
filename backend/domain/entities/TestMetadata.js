 ...
 * Tracks test file information, status, versioning, and  detection
 */
...
class TestMetadata {
  ...
  markAs(score = 100) {
    this._is = true;
    this._Score = Math.min(score, 100);
    this._updatedAt = new Date();
  }
  ...
  static fromJSON(data) {
    ...
    if (typeof data.Score === 'number') instance._Score = data.Score;
