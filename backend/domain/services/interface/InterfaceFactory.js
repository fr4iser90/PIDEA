...
class InterfaceFactory {
  ...
  registerDefaultConfig(interfaceType, config) {
    ...
    this.logger.info(
      `Registered default config for interface type: ${interfaceType}`,
      {
        interfaceType,
        config,
      },
  ...
  registerTypeDetector(interfaceType, detector) {
    ...
    this.logger.info(
      `Registered type detector for interface type: ${interfaceType}`,
    );
  }
  ...
  registerCreationHook(interfaceType, hook) {
    ...
    this.logger.info(
      `Registered creation hook for interface type: ${interfaceType}`,
    );
  }
  ...
  async createMultipleInterfaces(specifications = []) {
    ...
    this.logger.info(
      `Created ${results.length} interfaces, ${errors.length} failed`,
      {
