    ...
    async moveTaskToCompleted(taskId) {
        try {
            ...
            if (task.status.value === 'completed') {
                this.logger.info('✅ Task already completed', { taskId });
            ...
            // 4. Move files from in-progress/ to completed/[quarter]/
            ...
            const newPath = `docs/09_roadmap/completed/${quarter}/${task.category}/${task.name}/`;
