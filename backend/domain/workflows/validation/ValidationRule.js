...
class ValidationRule {
  ...
  async validate(value, context = null) {
    ...
    try {
      if (typeof this._validator === "function") {
        ...
        return await this._executeBuiltInValidator(
          value,
          this._validator,
          context,
        );
  ...
  _validateString(value) {
    if (value !== null && value !== undefined && typeof value !== "string") {
      return ValidationResult.createFieldTypeError(
        this._field,
        "string",
        typeof value,
      );
  ...
  _validateMin(value) {
    ...
    if (typeof value === "number" && value < min) {
      return ValidationResult.createFieldRangeError(
        this._field,
        min,
        undefined,
        value,
    ...
    if (typeof value === "string" && value.length < min) {
      return ValidationResult.createFieldLengthError(
        this._field,
        min,
        undefined,
        value.length,
  ...
  _validateEnum(value) {
    ...
    if (!allowedValues.includes(value)) {
      return ValidationResult.createFieldEnumError(
        this._field,
        allowedValues,
        value,
      );
  ...
  async _validateCustom(value, context) {
    ...
    if (!customValidator || typeof customValidator !== "function") {
      throw new Error(
        "Custom validator function is required for custom validation",
      );
    }
  ...
  _validate() {
    ...
    if (
      typeof this._validator !== "function" &&
      typeof this._validator !== "string"
    ) {
  ...
  toJSON() {
    return {
      ...
      field: this._field,
      validator:
        typeof this._validator === "function" ? "custom" : this._validator,
  ...
  static createMinLength(field, minLength, options = {}) {
    return ValidationRule.create("minLength", field, "minLength", {
      ...options,
      minLength,
    });
  }
  ...
  static createMaxLength(field, maxLength, options = {}) {
    return ValidationRule.create("maxLength", field, "maxLength", {
      ...options,
      maxLength,
    });
  }
  ...
  static createPattern(field, pattern, options = {}) {
    return ValidationRule.create("pattern", field, "pattern", {
      ...options,
      pattern,
    });
  }
  ...
  static createEnum(field, allowedValues, options = {}) {
    return ValidationRule.create("enum", field, "enum", {
      ...options,
      enum: allowedValues,
    });
  }
  ...
  static createCustom(name, field, validator, options = {}) {
    return ValidationRule.create(name, field, "custom", {
      ...options,
