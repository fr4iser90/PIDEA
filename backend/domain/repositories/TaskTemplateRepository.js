...
class TaskTemplateRepository {
  ...
  async findInactive(filters = {}) {
    throw new Error("findInactive method must be implemented");
  }
  async findMostUsed(limit = 10, filters = {}) {
    throw new Error("findMostUsed method must be implemented");
  }
  async findRecentlyUsed(days = 7, filters = {}) {
    throw new Error("findRecentlyUsed method must be implemented");
  }
