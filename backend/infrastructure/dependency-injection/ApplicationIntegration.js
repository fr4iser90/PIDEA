...
class ApplicationIntegration {
  ...
  async initializeInfrastructureWithDI() {
    ...
    this.userSessionRepository = this.serviceRegistry.getService(
      "userSessionRepository",
    );
    this.ideWorkspaceDetectionService = this.serviceRegistry.getService(
      "ideWorkspaceDetectionService",
    );
    this.fileSystemService =
      this.serviceRegistry.getService("fileSystemService");
    this.monorepoStrategy = this.serviceRegistry.getService("monorepoStrategy");
    this.singleRepoStrategy =
      this.serviceRegistry.getService("singleRepoStrategy");
  ...
  async initializeDomainServicesWithDI() {
    ...
    this.codeQualityAnalyzer = this.serviceRegistry.getService(
      "codeQualityAnalyzer",
    );
    this.securityAnalyzer = this.serviceRegistry.getService("securityAnalyzer");
    this.performanceAnalyzer = this.serviceRegistry.getService(
      "performanceAnalyzer",
    );
    this.architectureAnalyzer = this.serviceRegistry.getService(
      "architectureAnalyzer",
    );
    this.techStackAnalyzer =
      this.serviceRegistry.getService("techStackAnalyzer");
    this.subprojectDetector =
      this.serviceRegistry.getService("subprojectDetector");
    this.analysisOutputService = this.serviceRegistry.getService(
      "analysisOutputService",
    );
    this.analysisRepository =
      this.serviceRegistry.getService("analysisRepository");
    this.projectMappingService = this.serviceRegistry.getService(
      "projectMappingService",
    );
    this.taskRepository = this.serviceRegistry.getService("taskRepository");
    this.taskExecutionRepository = this.serviceRegistry.getService(
      "taskExecutionRepository",
    );
    this.taskService = this.serviceRegistry.getService("taskService");

    this.taskValidationService = this.serviceRegistry.getService(
      "taskValidationService",
    );
    this.taskAnalysisService = this.serviceRegistry.getService(
      "taskAnalysisService",
    );
    this.codeQualityService =
      this.serviceRegistry.getService("codeQualityService");
    this.securityService = this.serviceRegistry.getService("securityService");
    this.performanceService =
      this.serviceRegistry.getService("performanceService");
    this.architectureService = this.serviceRegistry.getService(
      "architectureService",
    );
  ...
  async initializeApplicationHandlersWithDI() {
    ...
    this.sendMessageHandler =
      this.serviceRegistry.getService("sendMessageHandler");
    this.getChatHistoryHandler = this.serviceRegistry.getService(
      "getChatHistoryHandler",
    );
    this.createTaskHandler =
      this.serviceRegistry.getService("createTaskHandler");
