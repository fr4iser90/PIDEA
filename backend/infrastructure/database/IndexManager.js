...
class IndexManager {
  ...
  async getTableIndexes(tableName) {
    try {
      ...
      this.logger.error('Failed to get table indexes', { error: error.message });
      throw error;
    }
  }
  ...
  async getIndexUsageStats() {
    try {
      ...
      this.logger.error('Failed to get index usage statistics', { error: error.message });
      throw error;
    }
  }
  ...
  async generateIndexRecommendations(usageStats) {
    try {
      ...
      this.logger.error('Failed to generate index recommendations', { error: error.message });
      throw error;
    }
  }
  ...
  async findUnusedIndexes(usageStats) {
    try {
      ...
      this.logger.debug('Found unused indexes', { count: unusedIndexes.length });
      
      return unusedIndexes;
      
    } catch (error) {
      this.logger.error('Failed to find unused indexes', { error: error.message });
      throw error;
    }
  }
  ...
  async findDuplicateIndexes() {
    try {
      ...
      this.logger.debug('Found duplicate indexes', { count: duplicates.length });
      
      return duplicates;
      
    } catch (error) {
      this.logger.error('Failed to find duplicate indexes', { error: error.message });
      throw error;
    }
  }
  ...
  async findMissingIndexes() {
    try {
      ...
      this.logger.debug('Found missing indexes', { count: missingIndexes.length });
      
      return missingIndexes;
      
    } catch (error) {
      this.logger.error('Failed to find missing indexes', { error: error.message });
      throw error;
    }
  }
