...
class ExecutionUtils {
  ...
  async collectProjectData(target, execution) {
    ...
    if (!fileSystemService) {
      throw new Error(
        "FileSystemService is required for collecting project data",
      );
    }
    ...
    const projectStructure =
      await fileSystemService.getProjectStructure(projectPath);
    ...
    const configFiles =
      await fileSystemService.getConfigurationFiles(projectPath);
