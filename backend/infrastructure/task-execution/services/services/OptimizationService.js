  ...
  async executeOptimizationTask(execution) {
    try {
      ...
      for (const file of files) {
        ...
        const optimizationResult = await this.aiService.optimizeCode(
          fileContent,
          {
      ...
      if (execution.options.autoApply) {
        appliedOptimizations = await this.applyOptimizations(
          optimizationResults,
          execution,
        );
      }
      ...
      const result = {
        ...
        summary: {
          ...
          optimizationsFound: optimizationResults.reduce(
