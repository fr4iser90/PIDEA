 ...
 * Defines hierarchical task categories for the PIDEA system
 * Based on actual backend categories and task types
 */
 ...
 */
const getCategoryInfo = (category, subcategory = null) => {
 ...
 */
const isValidCategoryCombination = (category, subcategory) => {
 ...
 */
const mapTaskTypeToCategory = (taskType) => {
  ...
  if (type.includes("analysis") || type.includes("analyze")) {
    return {
      category: "analysis",
      subcategory: type.includes("architecture")
        ? "architecture"
  ...
  if (type.includes("test")) {
    return {
      category: "testing",
      subcategory: type.includes("unit")
        ? "unit"
  ...
  if (type.includes("refactor")) {
    return {
      ...
      subcategory: type.includes("organize")
        ? "organize_modules"
        : type.includes("restructure")
  ...
  if (type.includes("deploy")) {
    return {
      category: "deployment",
      subcategory: type.includes("production")
        ? "production"
              ...
              : type.includes("infrastructure")
                ...
                : type.includes("monitoring")
                  ...
                  : type.includes("rollback")
                    ? "rollback"
                    : type.includes("ci") || type.includes("cd")
                      ? "ci_cd"
                      : "general",
    };
  }
  ...
  if (type.includes("generate")) {
    return {
      category: "generate",
      subcategory: type.includes("config")
        ? "configs"
  ...
  if (type.includes("security")) {
    return {
      category: "security",
      subcategory: type.includes("audit")
        ? "audit"
  ...
  if (type.includes("optimization") || type.includes("optimize")) {
    return {
      ...
      subcategory: type.includes("performance")
        ? "performance"
