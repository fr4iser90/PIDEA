...
const { DatabaseAnalysisService } = require('@application/services/categories/analysis/performance');
...
class DatabaseAnalysisController {
  ...
  async getConfiguration(req, res) {
    try {
      ...
      this.logger.error('Failed to get database configuration', { error: error.message });
  ...
  async getStatus(req, res) {
    try {
      ...
      this.logger.error('Failed to get database status', { error: error.message });
