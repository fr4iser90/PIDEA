...
class ProjectInterfaceController {
  constructor(interfaceManager, projectApplicationService) {
    ...
    if (!this.interfaceManager) {
      throw new Error('ProjectInterfaceController requires interfaceManager dependency');
    }
    if (!this.projectApplicationService) {
      throw new Error('ProjectInterfaceController requires projectApplicationService dependency');
    }
  }
  ...
  async getInterfaceStatus(req, res) {
    try {
      const { projectId, interfaceId } = req.params;
      const status = await this.interfaceManager.getInterfaceStatus(projectId, interfaceId);
  ...
  async getInterfaceLogs(req, res) {
    try {
      ...
      const logs = await this.interfaceManager.getInterfaceLogs(projectId, interfaceId, {
  ...
  async getIDEFeatures(req, res) {
    try {
      ...
      this.logger.info(`Getting IDE features for interface: ${interfaceId} in project: ${projectId}`);
  ...
  async getIDEVersion(req, res) {
    try {
      ...
      this.logger.info(`Getting IDE version for interface: ${interfaceId} in project: ${projectId}`);
  ...
  async getWorkspaceInfo(req, res) {
    try {
      ...
      this.logger.info(`Getting workspace info for interface: ${interfaceId} in project: ${projectId}`);
  ...
  async setWorkspacePath(req, res) {
    try {
      ...
      this.logger.info(`Setting workspace path for interface: ${interfaceId} in project: ${projectId}`);
  ...
  async detectWorkspacePaths(req, res) {
    try {
      ...
      this.logger.info(`Detecting workspace paths for interface: ${interfaceId} in project: ${projectId}`);
  ...
  async monitorTerminal(req, res) {
    try {
      ...
      this.logger.info(`Monitoring terminal for interface: ${interfaceId} in project: ${projectId}`);
