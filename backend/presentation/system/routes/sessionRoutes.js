...
class SessionRoutes {
  ...
  setupRoutes(app) {
    ...
    app.post("/api/session/extend", (req, res) =>
      this.sessionController.extendSession(req, res),
    );

    // Get session status
    app.get("/api/session/status", (req, res) =>
      this.sessionController.getSessionStatus(req, res),
    );

    // Record session activity
    app.post("/api/session/activity", (req, res) =>
      this.sessionController.recordActivity(req, res),
    );
    ...
    app.get("/api/session/analytics", (req, res) =>
      this.sessionController.getSessionAnalytics(req, res),
    );

    // Get monitoring data
    app.get("/api/session/monitor", (req, res) =>
      this.sessionController.getMonitoringData(req, res),
    );
    ...
    app.post("/api/session/cleanup", (req, res) =>
      this.sessionController.triggerCleanup(req, res),
    );

    // Update session configuration
    app.put("/api/session/config", (req, res) =>
      this.sessionController.updateConfig(req, res),
    );
