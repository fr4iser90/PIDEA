...
class InterfaceRoutes {
  ...
  setupRoutes(app) {
    ...
    app.post('/api/projects/:projectId/interfaces', 
    ...
    // Start interface
    app.post('/api/projects/:projectId/interfaces/:interfaceId/start', 
      this.interfaceMiddleware.validateInterfaceId, 
      (req, res) => this.interfaceController.startInterface(req, res));
    
    // Stop interface
    app.post('/api/projects/:projectId/interfaces/:interfaceId/stop', 
      this.interfaceMiddleware.validateInterfaceId, 
      (req, res) => this.interfaceController.stopInterface(req, res));
    
    // Restart interface
    app.post('/api/projects/:projectId/interfaces/:interfaceId/restart', 
      this.interfaceMiddleware.validateInterfaceId, 
    ...
    app.get('/api/projects/:projectId/interfaces/:interfaceId/status', 
      this.interfaceMiddleware.validateInterfaceId, 
      (req, res) => this.interfaceController.getInterfaceStatus(req, res));
    
    // Get interface logs
    app.get('/api/projects/:projectId/interfaces/:interfaceId/logs', 
      this.interfaceMiddleware.validateInterfaceId, 
    ...
    // Get IDE features
    app.get('/api/projects/:projectId/interfaces/:interfaceId/features', 
      this.interfaceMiddleware.validateInterfaceId, 
      (req, res) => this.interfaceController.getIDEFeatures(req, res));
    
    // Get IDE version
    app.get('/api/projects/:projectId/interfaces/:interfaceId/version', 
      this.interfaceMiddleware.validateInterfaceId, 
      (req, res) => this.interfaceController.getIDEVersion(req, res));
    
    // Get workspace info
    app.get('/api/projects/:projectId/interfaces/:interfaceId/workspace-info', 
      this.interfaceMiddleware.validateInterfaceId, 
      (req, res) => this.interfaceController.getWorkspaceInfo(req, res));
    
    // Set workspace path
    app.post('/api/projects/:projectId/interfaces/:interfaceId/set-workspace', 
      this.interfaceMiddleware.validateInterfaceId, 
      (req, res) => this.interfaceController.setWorkspacePath(req, res));
    
    // Detect workspace paths
    app.post('/api/projects/:projectId/interfaces/:interfaceId/detect-workspace-paths', 
      this.interfaceMiddleware.validateInterfaceId, 
      (req, res) => this.interfaceController.detectWorkspacePaths(req, res));
    
    // Monitor terminal
    app.post('/api/projects/:projectId/interfaces/:interfaceId/monitor-terminal', 
      this.interfaceMiddleware.validateInterfaceId, 
