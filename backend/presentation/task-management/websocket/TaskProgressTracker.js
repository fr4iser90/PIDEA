...
class TaskProgressTracker {
  ...
  handleTaskExecutionStart(data) {
    try {
      ...
      this.logger.error(
        "TaskProgressTracker: Failed to handle task execution start",
        {
          error: error.message,
        },
      );
  ...
  handleTaskExecutionProgress(data) {
    try {
      ...
      this.logger.error(
        "TaskProgressTracker: Failed to handle task execution progress",
        {
          error: error.message,
        },
      );
  ...
  handleTaskExecutionComplete(data) {
    try {
      ...
      this.logger.error(
        "TaskProgressTracker: Failed to handle task execution complete",
        {
          error: error.message,
        },
      );
  ...
  handleTaskExecutionError(data) {
    try {
      ...
      this.logger.error(
        "TaskProgressTracker: Failed to handle task execution error",
        {
          error: error.message,
        },
      );
  ...
  handleAutoModeStart(data) {
    try {
      ...
      this.logger.error(
        "TaskProgressTracker: Failed to handle auto mode start",
        {
          error: error.message,
        },
      );
  ...
  handleAutoModeProgress(data) {
    try {
      ...
      this.logger.error(
        "TaskProgressTracker: Failed to handle auto mode progress",
        {
          error: error.message,
        },
      );
  ...
  handleAutoModeComplete(data) {
    try {
      ...
      this.logger.error(
        "TaskProgressTracker: Failed to handle auto mode complete",
        {
          error: error.message,
        },
      );
  ...
  handleAutoModeError(data) {
    try {
      ...
      this.logger.error(
        "TaskProgressTracker: Failed to handle auto mode error",
        {
          error: error.message,
        },
      );
  ...
  handleGenericProgressStart(type, data) {
    try {
      ...
      this.logger.error(
        "TaskProgressTracker: Failed to handle generic progress start",
        {
          type,
          error: error.message,
        },
  ...
  handleGenericProgressUpdate(type, data) {
    try {
      ...
      this.logger.error(
        "TaskProgressTracker: Failed to handle generic progress update",
        {
          type,
          error: error.message,
        },
  ...
  handleGenericProgressComplete(type, data) {
    try {
      ...
      this.logger.error(
        "TaskProgressTracker: Failed to handle generic progress complete",
        {
          type,
          error: error.message,
        },
  ...
  handleGenericProgressError(type, data) {
    try {
      ...
      this.logger.error(
        "TaskProgressTracker: Failed to handle generic progress error",
        {
          type,
          error: error.message,
        },
    ...
    try {
      for (const [taskId, progressData] of this.activeTasks.entries()) {
        if (progressData.status === "running") {
          ...
          const metrics =
            await this.taskMonitoringService.getTaskMetrics(taskId);
          if (metrics) {
            progressData.metrics = { ...progressData.metrics, ...metrics };
          }
          ...
          if (progressData.startTime && progressData.estimatedDuration) {
            ...
            const remaining = Math.max(
              0,
              progressData.estimatedDuration - elapsed,
            );
      ...
      this.logger.error(
        "TaskProgressTracker: Failed to update active task progress",
        {
          error: error.message,
        },
      );
  ...
  cleanupCompletedTasks() {
    try {
      ...
      for (const [taskId, progressData] of this.activeTasks.entries()) {
        if (
          ...
          if (timeSinceCompletion > 300000) {
            ...
            this.activeTasks.delete(taskId);
            this.logger.debug(
              "TaskProgressTracker: Cleaned up completed task",
              { taskId },
            );
          }
        }
      ...
      this.logger.error(
        "TaskProgressTracker: Failed to cleanup completed tasks",
        {
          error: error.message,
        },
      );
  ...
  async saveProgressHistory() {
    try {
      ...
      this.logger.error(
        "TaskProgressTracker: Failed to save progress history",
        {
          error: error.message,
        },
      );
  ...
  broadcastProgressUpdate(taskId, eventType, progressData) {
    try {
      ...
      this.logger.error(
        "TaskProgressTracker: Failed to broadcast progress update",
        {
          taskId,
          eventType,
          error: error.message,
