...
class DatabaseOptimizationController {
  ...
  async optimizeDatabase(req, res) {
    try {
      ...
      const result =
        await this.databaseOptimizationService.performOptimization(options);
  ...
  async getOptimizationRecommendations(req, res) {
    try {
      ...
      const recommendations =
        await this.databaseOptimizationService.getOptimizationRecommendations();
  ...
  async getOptimizationStatus(req, res) {
    try {
      ...
      const status =
        await this.databaseOptimizationService.getOptimizationStatus();
  ...
  async scheduleOptimization(req, res) {
    try {
      ...
      const result =
        await this.databaseOptimizationService.scheduleOptimization(schedule);
  ...
  async cancelOptimization(req, res) {
    try {
      ...
      const result =
        await this.databaseOptimizationService.cancelOptimization(scheduleId);
  ...
  async getOptimizationHistory(req, res) {
    try {
      ...
      res.success(
        ...
        200,
        { meta: { message: "Optimization history retrieved successfully" } },
      );
    } catch (error) {
