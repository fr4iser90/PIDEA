...
class CommandRegistry {
  ...
  static buildFromCategory(category, name, params, serviceRegistry = null) {
    ...
    const getCommandClass = (category, name) => {
      try {
        const commandMap = {
          analysis: {
            AdvancedAnalysisCommand: () =>
              require("./categories/analysis/AdvancedAnalysisCommand"),
            AnalyzeArchitectureCommand: () =>
              require("./categories/analysis/AnalyzeArchitectureCommand"),
            AnalyzeCodeQualityCommand: () =>
              require("./categories/analysis/AnalyzeCodeQualityCommand"),
            AnalyzeDependenciesCommand: () =>
              require("./categories/analysis/AnalyzeDependenciesCommand"),
            AnalyzeRepoStructureCommand: () =>
              require("./categories/analysis/AnalyzeRepoStructureCommand"),
            AnalyzeTechStackCommand: () =>
              require("./categories/analysis/AnalyzeTechStackCommand"),
            AnalyzeLayerViolationsCommand: () =>
              require("./categories/analysis/AnalyzeLayerViolationsCommand"),
          },
          generate: {
            GenerateConfigsCommand: () =>
              require("./categories/generate/GenerateConfigsCommand"),
            GenerateDocumentationCommand: () =>
              require("./categories/generate/GenerateDocumentationCommand"),
            GenerateScriptsCommand: () =>
              require("./categories/generate/GenerateScriptsCommand"),
            GenerateTestsCommand: () =>
              require("./categories/generate/GenerateTestsCommand"),
          },
          refactoring: {
            OrganizeModulesCommand: () =>
              require("./categories/refactoring/OrganizeModulesCommand"),
            RestructureArchitectureCommand: () =>
              require("./categories/refactoring/RestructureArchitectureCommand"),
            SplitLargeFilesCommand: () =>
              require("./categories/refactoring/SplitLargeFilesCommand"),
            CleanDependenciesCommand: () =>
              require("./categories/refactoring/CleanDependenciesCommand"),
          },
          management: {
            PortStreamingCommand: () =>
              require("./categories/management/PortStreamingCommand"),
            ProcessTodoListCommand: () =>
              require("./categories/management/ProcessTodoListCommand"),
            SendMessageCommand: () =>
              require("./categories/management/SendMessageCommand"),
            StartStreamingCommand: () =>
              require("./categories/management/StartStreamingCommand"),
            StopStreamingCommand: () =>
              require("./categories/management/StopStreamingCommand"),
            TestCorrectionCommand: () =>
              require("./categories/management/TestCorrectionCommand"),
            UpdateTestStatusCommand: () =>
              require("./categories/management/UpdateTestStatusCommand"),
          },
          workflow: {
            CreateTaskCommand: () =>
              require("./categories/workflow/CreateTaskCommand"),
            UpdateTestStatusCommand: () =>
              require("./categories/workflow/UpdateTestStatusCommand"),
          },
          ide: {
            CreateChatCommand: () =>
              require("./categories/ide/CreateChatCommand"),
            SendMessageCommand: () =>
              require("./categories/ide/SendMessageCommand"),
            SwitchChatCommand: () =>
              require("./categories/ide/SwitchChatCommand"),
            ListChatsCommand: () =>
              require("./categories/ide/ListChatsCommand"),
            CloseChatCommand: () =>
              require("./categories/ide/CloseChatCommand"),
            GetChatHistoryCommand: () =>
              require("./categories/ide/GetChatHistoryCommand"),
            OpenTerminalCommand: () =>
              require("./categories/ide/OpenTerminalCommand"),
            ExecuteTerminalCommand: () =>
              require("./categories/ide/ExecuteTerminalCommand"),
            MonitorTerminalOutputCommand: () =>
              require("./categories/ide/MonitorTerminalOutputCommand"),
            RestartUserAppCommand: () =>
              require("./categories/ide/RestartUserAppCommand"),
            TerminalLogCaptureCommand: () =>
              require("./categories/ide/TerminalLogCaptureCommand"),
            AnalyzeProjectCommand: () =>
              require("./categories/ide/AnalyzeProjectCommand"),
            AnalyzeAgainCommand: () =>
              require("./categories/ide/AnalyzeAgainCommand"),
            GetWorkspaceInfoCommand: () =>
              require("./categories/ide/GetWorkspaceInfoCommand"),
            DetectPackageJsonCommand: () =>
              require("./categories/ide/DetectPackageJsonCommand"),
            SwitchIDEPortCommand: () =>
              require("./categories/ide/SwitchIDEPortCommand"),
            OpenFileExplorerCommand: () =>
              require("./categories/ide/OpenFileExplorerCommand"),
            OpenCommandPaletteCommand: () =>
              require("./categories/ide/OpenCommandPaletteCommand"),
            ExecuteIDEActionCommand: () =>
              require("./categories/ide/ExecuteIDEActionCommand"),
            GetIDESelectorsCommand: () =>
              require("./categories/ide/GetIDESelectorsCommand"),
          },
          git: {
            GitAddFilesCommand: () =>
              require("./categories/git/GitAddFilesCommand"),
            GitCommitCommand: () =>
              require("./categories/git/GitCommitCommand"),
            GitPushCommand: () => require("./categories/git/GitPushCommand"),
            GitPullCommand: () => require("./categories/git/GitPullCommand"),
            GitCheckoutCommand: () =>
              require("./categories/git/GitCheckoutCommand"),
            GitCreateBranchCommand: () =>
              require("./categories/git/GitCreateBranchCommand"),
            GitMergeCommand: () => require("./categories/git/GitMergeCommand"),
            GitStatusCommand: () =>
              require("./categories/git/GitStatusCommand"),
            ...
            GitRemoteCommand: () =>
              require("./categories/git/GitRemoteCommand"),
            GitBranchCommand: () =>
              require("./categories/git/GitBranchCommand"),
            GitCreatePullRequestCommand: () =>
              require("./categories/git/GitCreatePullRequestCommand"),
          },
        };
        ...
        console.error(
          `Failed to load command ${category}/${name}:`,
          error.message,
        );
        return null;
      }
  ...
  static getByCategory(category) {
    ...
    if (!isValidCategory(category)) {
      throw new Error(
        `Invalid category: ${category}. Valid categories: ${Object.values(STANDARD_CATEGORIES).join(", ")}`,
      );
    }
  ...
  static getStats() {
    ...
    return {
      ...
      activeCommands: Array.from(instance.commands.values()).filter(
        (c) => c.status === "active",
      ).length,
      inactiveCommands: Array.from(instance.commands.values()).filter(
        (c) => c.status === "inactive",
      ).length,
    };
  }
  ...
  static validateConfig(config) {
    if (!config || typeof config !== "object") {
      return {
        isValid: false,
        errors: ["Command configuration must be an object"],
      };
    }
    ...
    if (!config.name) {
      return {
        isValid: false,
        errors: ['Command configuration must have a "name" property'],
      };
    }
