...
class AdvancedAnalysisCommand {
  ...
  validateBusinessRules() {
    ...
    if (
      ...
      !validFormats.includes(this.options.exportFormat)
    ) {
      errors.push(
    ...
    // Validate options
    if (
      !this.options.includeLayerValidation &&
      !this.options.includeLogicValidation &&
      !this.options.includeStandardAnalysis
    ) {
      warnings.push(
