...
class TestCorrectionCommand {
  ...
  getTaskDescription() {
    const descriptions = {
      "auto-fix":
        "Automatically fix failing, legacy, and complex tests to improve test reliability and coverage.",
      "coverage-improve":
        "Generate missing tests and improve existing test coverage to meet target coverage goals.",
      refactor:
        "Refactor tests for better maintainability, performance, and readability.",
      status: "Check current status of test correction tasks and progress.",
      report:
        "Generate detailed report of test correction activities and results.",
    };

    let description =
      descriptions[this.correctionType] ||
      "Perform test correction and improvement tasks.";
