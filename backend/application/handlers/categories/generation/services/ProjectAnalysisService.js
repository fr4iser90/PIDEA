...
class ProjectAnalysisService {
  ...
  async analyzeProjectForScripts(projectPath, scriptType) {
    try {
      this.logger.info(
        "ProjectAnalysisService: Analyzing project for script generation",
        {
          projectPath,
          scriptType,
        },
      ...
      const projectStructure =
        await this.projectAnalyzer.getProjectStructure(projectPath);
      ...
      const projectType =
        await this.projectAnalyzer.detectProjectType(projectPath);
      ...
      this.logger.error(
        "ProjectAnalysisService: Failed to analyze project for scripts",
        {
          projectPath,
          error: error.message,
        },
  ...
  async getExistingScripts(projectPath) {
    try {
      ...
      this.logger.warn(
        "ProjectAnalysisService: Failed to get existing scripts",
        {
          projectPath,
          error: error.message,
        },
