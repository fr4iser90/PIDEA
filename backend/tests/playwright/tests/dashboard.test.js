...
test.describe("Dashboard Tests", () => {
  ...
  test("should display dashboard correctly", async ({ page }) => {
    ...
    await expect(
      page.locator(testData.selectors.navigation.navMenu),
    ).toBeVisible();
    await expect(
      page.locator(testData.selectors.navigation.profileLink),
    ).toBeVisible();
    await expect(
      page.locator(testData.selectors.navigation.logoutButton),
    ).toBeVisible();
  });
  ...
  test("should handle project creation", async ({ page }) => {
    ...
    if (await createButton.isVisible()) {
      ...
      await page.fill(
        ...
        "A test project created by Playwright",
      );
  ...
  test("should display dashboard statistics", async ({ page }) => {
    ...
    if (await statsContainer.isVisible()) {
      await expect(
        statsContainer.locator(".stat-item"),
  ...
  test("should be responsive on different screen sizes", async ({ page }) => {
    ...
    await expect(
      page.locator(testData.selectors.navigation.menuButton),
    ).toBeVisible();
  });
