...
test.describe("Form Submission Tests", () => {
  test.beforeEach(async ({ page }) => {
    ...
    await page.fill(
      testData.selectors.login.usernameField,
      testData.testData.login.validCredentials.username,
    );
    await page.fill(
      testData.selectors.login.passwordField,
      testData.testData.login.validCredentials.password,
    );
  ...
  test("should submit contact form successfully", async ({ page }) => {
    ...
    if (await contactForm.isVisible()) {
      ...
      await page.fill(
        'input[name="name"]',
        testData.testData.forms.contactForm.name,
      );
      await page.fill(
        'input[name="email"]',
        testData.testData.forms.contactForm.email,
      );
      await page.fill(
        'textarea[name="message"]',
        testData.testData.forms.contactForm.message,
      );
  ...
  test("should validate required fields in contact form", async ({ page }) => {
    ...
    if (await contactForm.isVisible()) {
      ...
      await expect(
        page.locator('textarea[name="message"]:invalid'),
      ).toBeVisible();
  ...
  test("should submit registration form successfully", async ({ page }) => {
    ...
    if (await registrationForm.isVisible()) {
      ...
      await page.fill(
        ...
        testData.testData.forms.registrationForm.firstName,
      );
      await page.fill(
        'input[name="lastName"]',
        testData.testData.forms.registrationForm.lastName,
      );
      await page.fill(
        'input[name="email"]',
        testData.testData.forms.registrationForm.email,
      );
      await page.fill(
        'input[name="password"]',
        testData.testData.forms.registrationForm.password,
      );
      await page.fill(
        'input[name="confirmPassword"]',
        testData.testData.forms.registrationForm.confirmPassword,
      );
  ...
  test("should validate password confirmation in registration form", async ({
    page,
  }) => {
    // Navigate to registration page
    await page.goto("/register");
  ...
  test("should validate password strength in registration form", async ({
    page,
  }) => {
    // Navigate to registration page
    await page.goto("/register");
