  ...
  testTables: {
    users: {
      columns: [
        ...
        { name: 'is_active', type: 'BOOLEAN', notNull: true, defaultValue: true },
    ...
    projects: {
      columns: [
        ...
        { name: 'visibility', type: 'TEXT', notNull: true, defaultValue: 'private' }
      ],
      indexes: [
    ...
    tasks: {
      ...
      foreignKeys: [
        ...
        { column: 'assigned_to', references: 'users(id)', onDelete: 'SET NULL' },
    ...
    performance_metrics: {
      ...
      indexes: [
        ...
        { name: 'idx_performance_metrics_execution_time', columns: ['execution_time'] },
        { name: 'idx_performance_metrics_timestamp', columns: ['timestamp'] },
        { name: 'idx_performance_metrics_database_type', columns: ['database_type'] }
      ]
    }
  }
};
