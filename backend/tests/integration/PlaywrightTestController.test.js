...
describe("TestManagementController - Playwright Endpoints", () => {
  ...
  beforeEach(() => {
    ...
    // Add routes
    app.post(
      "/api/projects/:projectId/tests/playwright/execute",
      controller.executePlaywrightTests.bind(controller),
    );
    app.get(
      "/api/projects/:projectId/tests/playwright/results/:testId",
      controller.getPlaywrightTestResults.bind(controller),
    );
    app.get(
      "/api/projects/all/tests/playwright/results",
      controller.getAllPlaywrightTestResults.bind(controller),
    );
    app.get(
      "/api/projects/:projectId/tests/playwright/config",
      controller.getPlaywrightTestConfig.bind(controller),
    );
    app.put(
      "/api/projects/:projectId/tests/playwright/config",
      controller.updatePlaywrightTestConfig.bind(controller),
    );
    app.post(
      "/api/projects/validate/tests/playwright/config/validate",
      controller.validatePlaywrightTestConfig.bind(controller),
    );
    app.get(
      "/api/projects/:projectId/tests/playwright/projects",
      controller.getPlaywrightTestProjects.bind(controller),
    );
    app.post(
      "/api/projects/:projectId/tests/playwright/projects",
      controller.createPlaywrightTestProject.bind(controller),
    );
    app.get(
      "/api/projects/:projectId/tests/playwright/projects/:id/config",
      controller.getPlaywrightProjectConfig.bind(controller),
    );
    app.put(
      "/api/projects/:projectId/tests/playwright/projects/:id/config",
      controller.updatePlaywrightProjectConfig.bind(controller),
    );
    app.post(
      "/api/projects/:projectId/tests/playwright/login/validate",
      controller.validatePlaywrightLoginCredentials.bind(controller),
    );
    app.get(
      "/api/projects/status/tests/playwright/status",
      controller.getPlaywrightTestRunnerStatus.bind(controller),
    );
    app.post(
      "/api/projects/stop/tests/playwright/stop",
      controller.stopPlaywrightTests.bind(controller),
    );
    app.get(
      "/api/projects/:testId/tests/playwright/logs",
      controller.getPlaywrightTestLogs.bind(controller),
    );
  });
  ...
  describe("POST /api/projects/:projectId/tests/playwright/execute", () => {
    test("should execute Playwright tests successfully", async () => {
      ...
      mockPlaywrightTestHandler.handleExecuteTests.mockResolvedValue(
        mockResult,
      );
    ...
    test("should handle handler errors", async () => {
      const projectId = "test-project";
      mockPlaywrightTestHandler.handleExecuteTests.mockRejectedValue(
  ...
  describe("GET /api/projects/:projectId/tests/playwright/results/:testId", () => {
    test("should get test results successfully", async () => {
      ...
      mockPlaywrightTestHandler.handleGetTestResults.mockResolvedValue(
        mockResult,
      );
      ...
      expect(response.body.data).toBe(mockResult.result);
      expect(
        mockPlaywrightTestHandler.handleGetTestResults,
  ...
  describe("GET /api/projects/all/tests/playwright/results", () => {
    test("should get all test results successfully", async () => {
      ...
      mockPlaywrightTestHandler.handleGetAllTestResults.mockResolvedValue(
        mockResult,
      );
      ...
      expect(response.body.data).toBe(mockResult.result);
      expect(
        mockPlaywrightTestHandler.handleGetAllTestResults,
  ...
  describe("GET /api/projects/:projectId/tests/playwright/config", () => {
    test("should get test configuration successfully", async () => {
      ...
      mockPlaywrightTestHandler.handleConfigurationCommand.mockResolvedValue(
        mockResult,
      );
      ...
      expect(response.body.data).toBe(mockResult.result);
      expect(
        mockPlaywrightTestHandler.handleConfigurationCommand,
      ).toHaveBeenCalledWith({
        action: "get",
        projectId,
      });
  ...
  describe("GET /api/projects/:projectId/tests/playwright/projects", () => {
    test("should get test projects successfully", async () => {
          ...
          projects: [
            {
              id: "project-1",
              name: "Login Tests",
              path: "/path/login.test.js",
            },
            {
              id: "project-2",
              name: "Dashboard Tests",
              path: "/path/dashboard.test.js",
            },
          ],
          count: 2,
        },
      ...
      mockPlaywrightTestHandler.handleProjectCommand.mockResolvedValue(
        mockResult,
      );
      ...
      expect(response.body.data).toBe(mockResult.result);
      expect(
        mockPlaywrightTestHandler.handleProjectCommand,
      ).toHaveBeenCalledWith({
        action: "list",
        projectId,
      });
  ...
  describe("POST /api/projects/:projectId/tests/playwright/projects", () => {
    test("should create test project successfully", async () => {
      ...
      expect(response.body.data).toBe(mockResult.result);
      expect(response.body.message).toBe(
        "Playwright test project created successfully",
      );
      expect(
        mockPlaywrightTestHandler.handleProjectCommand,
      ).toHaveBeenCalledWith({
  ...
  describe("POST /api/projects/:projectId/tests/playwright/login/validate", () => {
    test("should validate login credentials successfully", async () => {
      ...
      mockPlaywrightTestHandler.handleValidateLoginCredentials.mockResolvedValue(
        mockResult,
      );
      ...
      expect(response.body.data).toBe(mockResult.result);
      expect(
        mockPlaywrightTestHandler.handleValidateLoginCredentials,
      ).toHaveBeenCalledWith({
        projectId,
        credentials,
      });
  ...
  describe("GET /api/projects/status/tests/playwright/status", () => {
    test("should get test runner status successfully", async () => {
      ...
      mockPlaywrightTestHandler.handleGetTestRunnerStatus.mockResolvedValue(
        mockResult,
      );
      ...
      expect(response.body.data).toBe(mockResult.result);
      expect(
        mockPlaywrightTestHandler.handleGetTestRunnerStatus,
      ).toHaveBeenCalledWith({});
    });
  });
  ...
  describe("POST /api/projects/stop/tests/playwright/stop", () => {
    test("should stop tests successfully", async () => {
      ...
      expect(response.body.data).toBe(mockResult.result);
      expect(response.body.message).toBe(
        "Playwright tests stopped successfully",
      );
      expect(mockPlaywrightTestHandler.handleStopTests).toHaveBeenCalledWith({
        testId,
      });
    });
  });
  ...
  describe("GET /api/projects/:testId/tests/playwright/logs", () => {
    test("should get test logs successfully", async () => {
      ...
      const response = await request(app)
        .get(
          `/api/projects/${testId}/tests/playwright/logs?testId=${testId}&lines=${lines}`,
        )
        .expect(200);
