...
describe("IDEManager Integration", () => {
  ...
  describe("detector factory integration", () => {
    ...
    it("should validate detectors", () => {
      ...
      expect(ideManager.detectorFactory.validateDetector("windsurf")).toBe(
        true,
      );
    });
  ...
  describe("error handling", () => {
    it("should handle initialization errors gracefully", async () => {
      ...
      jest
        .spyOn(ideManager.configManager, "loadConfig")
    ...
    it("should handle detector factory errors", async () => {
      ...
      jest
        .spyOn(ideManager.detectorFactory, "detectAll")
        .mockRejectedValue(new Error("Detection error"));

      await expect(ideManager.getAvailableIDEs()).rejects.toThrow(
        "Detection error",
      );
    });
  });
