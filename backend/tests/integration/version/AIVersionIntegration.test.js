...
describe("AI Version Integration", () => {
  ...
  describe("End-to-End AI Analysis", () => {
    it("should perform complete AI analysis workflow", async () => {
      ...
      const result = await hybridDetector.determineBumpType(
        changelog,
        projectPath,
        context,
      );
    ...
    it("should handle AI service failures gracefully", async () => {
      ...
      const result = await failingHybridDetector.determineBumpType(
        changelog,
        projectPath,
      );
  ...
  describe("Version Management Service Integration", () => {
    ...
    it("should use hybrid detection in version bump determination", async () => {
      ...
      const result = await versionManagementService.determineBumpType(
        task,
        projectPath,
        context,
      );
          ...
          choices: [
            {
              message: {
                content: JSON.stringify({
                  ...
                  confidence: 0.8,
                  reasoning:
                    "New API endpoint is a backward-compatible feature",
  ...
  describe("Performance and Caching", () => {
    it("should cache analysis results", async () => {
      ...
      // First call
      const result1 = await hybridDetector.determineBumpType(
        changelog,
        projectPath,
      );

      // Second call with same parameters
      const result2 = await hybridDetector.determineBumpType(
        changelog,
        projectPath,
      );
  ...
  describe("Health Monitoring", () => {
    it("should provide health status for all services", async () => {
      ...
      const versionHealth = versionManagementService.getHealthStatus?.() || {
        status: "healthy",
      };
