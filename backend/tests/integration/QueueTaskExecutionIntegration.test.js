...
describe("QueueTaskExecutionService Integration", () => {
  ...
  describe("TaskService Integration", () => {
    it("should use QueueTaskExecutionService when executing tasks", async () => {
      ...
      mockTaskQueueStore.addToProjectQueue.mockResolvedValue({
        queueId: "queue-1",
        status: "queued",
      });
  ...
  describe("Error Handling Integration", () => {
    it("should handle queue service failures gracefully", async () => {
      ...
      mockTaskRepository.findById.mockResolvedValue(mockTask);
      mockTaskQueueStore.addToProjectQueue.mockRejectedValue(
    ...
    it("should handle missing dependencies gracefully", async () => {
      ...
      await expect(
        ...
        "Cannot read properties of undefined (reading 'addToProjectQueue')",
      );
    });
  });
});
