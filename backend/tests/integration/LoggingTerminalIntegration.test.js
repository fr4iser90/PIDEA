...
describe("Logging Terminal Integration", () => {
  ...
  describe("Time Formatter Integration", () => {
    it("should format timestamps correctly", () => {
      ...
      expect(typeof timeFormatter.formatTimestamp(testDate, "console")).toBe(
        "string",
      );
      expect(typeof timeFormatter.formatTimestamp(testDate, "compact")).toBe(
        "string",
      );
      expect(typeof timeFormatter.formatTimestamp(testDate, "file")).toBe(
        "string",
      );
    });
    ...
    it("should recommend formats based on terminal capabilities", () => {
      ...
      expect(timeFormatter.getRecommendedFormat(terminalInfo, "console")).toBe(
        "compact",
      );
    });
  });
