...
describe("Category Routes Integration", () => {
        ...
        endpoints.forEach((endpoint) => {
          it(`should have ${category}/${endpoint} endpoint`, async () => {
            const response = await request(app)
              .get(
                `/api/projects/${testProjectId}/analysis/${category}/${endpoint}`,
              )
              .expect(200);
  ...
  describe("Recommendations Endpoint", () => {
    categories.forEach((category) => {
      it(`should return recommendations for ${category}`, async () => {
        const response = await request(app)
          .get(
            `/api/projects/${testProjectId}/analysis/${category}/recommendations`,
          )
          .expect(200);
  ...
  describe("Error Handling", () => {
    ...
    it("should handle invalid category", async () => {
      const response = await request(app)
        .get(
          `/api/projects/${testProjectId}/analysis/invalid-category/recommendations`,
        )
    ...
    it("should handle invalid endpoint", async () => {
      const response = await request(app)
        .get(
          `/api/projects/${testProjectId}/analysis/code-quality/invalid-endpoint`,
        )
        .expect(404);
    });
  });
