...
describe("TaskStatusSyncStep Integration Tests", () => {
  ...
  beforeAll(async () => {
    ...
    taskRepository =
      new (require("@infrastructure/database/PostgreSQLTaskRepository"))(
        mockDatabase,
      );
  ...
  describe("Service Integration", () => {
    ...
    it("should integrate with TaskStatusTransitionService", async () => {
      ...
      expect(services.statusTransitionService).toBeInstanceOf(
  ...
  describe("End-to-End Workflows", () => {
    it("should handle complete sync workflow", async () => {
      ...
      expect(statusTransitionService.moveTaskToInProgress).toHaveBeenCalledWith(
        "integration-test-task",
      );
    ...
    it("should handle batch sync workflow", async () => {
      ...
      expect(
        statusTransitionService.moveTaskToInProgress,
    ...
    it("should handle rollback workflow", async () => {
      ...
      expect(statusTransitionService.moveTaskToPending).toHaveBeenCalledTimes(
        2,
      );
