  ...
  describe("instance methods", () => {
    describe("getSelectors", () => {
      it("should return selectors from version manager", async () => {
        ...
        selectorManager.versionManager.getSelectors = jest
          .fn()
        ...
        expect(
          selectorManager.versionManager.getSelectors,
        ).toHaveBeenCalledWith("cursor", "0.42.0");
      });
      ...
      it("should handle errors gracefully", async () => {
        ...
        selectorManager.versionManager.getFallbackSelectors = jest
          .fn()
          .mockReturnValue(mockFallbackSelectors);
  ...
  describe("static methods", () => {
    ...
    describe("getAvailableVersions", () => {
      it("should return available versions for IDE type", () => {
        const cursorVersions =
          IDESelectorManager.getAvailableVersions("cursor");
    ...
    describe("getSelector", () => {
      ...
      it("should return null for non-existent element types", () => {
        const selector = IDESelectorManager.getSelector(
          "cursor",
          "non-existent",
        );
