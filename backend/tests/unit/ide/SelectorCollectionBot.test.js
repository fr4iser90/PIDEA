...
describe("SelectorCollectionBot", () => {
  ...
  describe("collectSelectors", () => {
    ...
    it("should throw error when no selectors collected", async () => {
      ...
      await expect(
        bot.collectSelectors("cursor", "1.6.0", 9222),
      ).rejects.toThrow("No selectors collected for cursor version 1.6.0");
    });
  ...
  describe("saveSelectors", () => {
    it("should save selectors successfully", async () => {
      ...
      expect(mockIDETypesUpdater.updateVersion).toHaveBeenCalledWith(
        "cursor",
        "1.6.0",
        selectors,
      );
  ...
  describe("testSelectors", () => {
    it("should test selectors successfully", async () => {
      ...
      const result = await bot.testSelectors(
        "cursor",
        "1.6.0",
        selectors,
        9222,
