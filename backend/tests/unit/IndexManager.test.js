...
describe("IndexManager", () => {
  ...
  describe("createIndex", () => {
    ...
    it("should handle index creation errors", async () => {
      ...
      await expect(
        indexManager.createIndex(table, columns, options),
  ...
  describe("dropIndex", () => {
    ...
    it("should handle non-existent index", async () => {
      ...
      await expect(indexManager.dropIndex(indexName)).rejects.toThrow(
  ...
  describe("analyzeIndexUsage", () => {
    ...
    it("should handle analysis errors", async () => {
      ...
      await expect(indexManager.analyzeIndexUsage()).rejects.toThrow(
        "Analysis failed",
      );
    });
  });
  ...
  describe("generateIndexRecommendations", () => {
    it("should generate index recommendations", async () => {
      ...
      const result =
        await indexManager.generateIndexRecommendations(usageStats);
  ...
  describe("performIndexMaintenance", () => {
    ...
    it("should handle maintenance errors", async () => {
      ...
      await expect(
        indexManager.performIndexMaintenance(indexName),
