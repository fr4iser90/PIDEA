...
describe("FrameworkLoader Unit Tests", () => {
  ...
  describe("Framework Discovery", () => {
    test("should discover framework directories", async () => {
      ...
      expect(frameworkLoader.frameworkPaths.has("another_framework")).toBe(
        true,
      );
    });
  ...
  describe("Framework Configuration Loading", () => {
    test("should load valid framework configuration", async () => {
      ...
      await frameworkLoader.loadFrameworkConfig(
        "test_framework",
        mockFrameworkPath,
      );
      ...
      const loadedFramework =
        frameworkLoader.loadedFrameworks.get("test_framework");
    ...
    test("should create default configuration for missing config file", async () => {
      ...
      expect(frameworkLoader.loadedFrameworks.has("missing_framework")).toBe(
        true,
      );
      const loadedFramework =
        frameworkLoader.loadedFrameworks.get("missing_framework");
    ...
    test("should handle invalid JSON configuration", async () => {
      ...
      await expect(
        frameworkLoader.loadFrameworkConfig(
          "invalid_framework",
          mockFrameworkPath,
        ),
      ).rejects.toThrow();
      ...
      const loadedFramework =
        frameworkLoader.loadedFrameworks.get("invalid_framework");
  ...
  describe("Framework Validation", () => {
    test("should validate framework configuration", () => {
      ...
      expect(() =>
        frameworkLoader.validateFrameworkConfig(validConfig),
      ).not.toThrow();
    });
    ...
    test("should reject invalid framework configuration", () => {
      ...
      expect(() =>
        frameworkLoader.validateFrameworkConfig(invalidConfig),
      ).toThrow();
    });
    ...
    test("should validate activation settings", () => {
      ...
      expect(() =>
        frameworkLoader.validateFrameworkConfig(configWithActivation),
      ).toThrow();
    });
  });
  ...
  describe("Framework Management", () => {
    ...
    test("should unload framework", async () => {
      ...
      expect(frameworkLoader.loadedFrameworks.has("test_framework")).toBe(
        false,
      );
    });
  ...
  describe("Error Handling", () => {
    test("should handle file system errors gracefully", async () => {
      ...
      await expect(frameworkLoader.discoverFrameworks()).rejects.toThrow(
        "Permission denied",
      );
    });
    ...
    test("should handle domain registry errors gracefully", async () => {
      ...
      frameworkRegistry.registerFramework.mockRejectedValue(
