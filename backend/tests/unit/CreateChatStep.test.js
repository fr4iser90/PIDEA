...
describe("CreateChatStep", () => {
  ...
  describe("Configuration", () => {
    test("should have correct configuration", () => {
      ...
      expect(config.description).toBe(
        "Create new chat session with IDE integration",
      );
  ...
  describe("Context Validation", () => {
    ...
    test("should throw error for missing userId", () => {
      ...
      expect(() => stepInstance.validateContext(context)).toThrow(
        "User ID is required",
      );
    });
  ...
  describe("Service Dependencies", () => {
    test("should throw error for missing ChatSessionService", () => {
      ...
      return expect(stepInstance.execute(context)).rejects.toThrow(
        "ChatSessionService not available",
      );
    });
    ...
    test("should throw error for missing BrowserManager", () => {
      ...
      context.getService.mockImplementation((serviceName) => {
        ...
        return serviceName === "ChatSessionService"
          ? mockChatSessionService
          : mockEventBus;
      });

      return expect(stepInstance.execute(context)).rejects.toThrow(
        "BrowserManager not available",
      );
    });
  });
  ...
  describe("Error Handling", () => {
    ...
    test("should handle session creation failure", async () => {
      mockChatSessionService.createSession.mockRejectedValue(
