...
describe("TokenValidator", () => {
  ...
  describe("validateSessionToken", () => {
    it("should validate session token successfully", () => {
      const result = tokenValidator.validateSessionToken(
        testToken,
        mockSession,
      );
  ...
  describe("validateTokens (Batch Operations)", () => {
    ...
    it("should throw error for mismatched arrays", () => {
      ...
      expect(() => tokenValidator.validateTokens(tokens, sessions)).toThrow(
        "Tokens and sessions must be arrays",
      );
    });

    it("should throw error for non-array input", () => {
      expect(() => tokenValidator.validateTokens("not-array", [])).toThrow(
        "Tokens and sessions must be arrays",
      );
      expect(() => tokenValidator.validateTokens([], "not-array")).toThrow(
        "Tokens and sessions must be arrays",
