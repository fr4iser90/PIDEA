...
describe("TemplateSearch", () => {
  ...
  describe("searchTemplates", () => {
    ...
    it("should return empty array when no templates match", () => {
      const results = TemplateSearch.searchTemplates(
        mockTemplates,
        "nonexistent",
      );
  ...
  describe("searchByCategory", () => {
    it("should return templates for valid category", () => {
      const results = TemplateSearch.searchByCategory(
        mockTemplates,
        "web-apps",
      );
  ...
  describe("getTemplate", () => {
    it("should return template for valid category and name", () => {
      const result = TemplateSearch.getTemplate(
        mockTemplates,
        "web-apps",
        "react-app",
      );
  ...
  describe("Integration tests", () => {
    it("should work together for complex search scenarios", () => {
      ...
      // Search by category
      const webAppsTemplates = TemplateSearch.searchByCategory(
        mockTemplates,
        "web-apps",
      );
      ...
      const reactTemplate = TemplateSearch.getTemplate(
        mockTemplates,
        "web-apps",
        "react-app",
      );
      ...
      // Search templates
      const searchResults = TemplateSearch.searchTemplates(
        mockTemplates,
        "react",
      );
