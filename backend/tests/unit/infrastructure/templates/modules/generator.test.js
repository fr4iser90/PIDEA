...
describe("TemplateGenerator", () => {
  ...
  describe("generateScript", () => {
    ...
    it("should generate script with provided variables", () => {
      ...
      expect(TemplateValidator.validateTemplate).toHaveBeenCalledWith(
        validTemplate,
      );
      expect(TemplateValidator.validateVariables).toHaveBeenCalledWith(
        variables,
      );
    });
  ...
  describe("createCustomTemplate", () => {
    ...
    it("should create custom template with valid template", () => {
      ...
      const result = TemplateGenerator.createCustomTemplate(
        validTemplate,
        mockEventBus,
      );
  ...
  describe("processVariables", () => {
    ...
    it("should merge user variables with template defaults", () => {
      ...
      const result = TemplateGenerator.processVariables(
