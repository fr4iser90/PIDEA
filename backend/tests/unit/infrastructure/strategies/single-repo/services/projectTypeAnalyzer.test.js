...
describe("ProjectTypeAnalyzer", () => {
  ...
  describe("constructor", () => {
    ...
    it("should handle undefined logger gracefully", () => {
      const analyzerWithoutLogger = new ProjectTypeAnalyzer(
        undefined,
        mockFileUtils,
      );
    ...
    it("should handle undefined fileUtils gracefully", () => {
      const analyzerWithoutFileUtils = new ProjectTypeAnalyzer(
        mockLogger,
        undefined,
      );
  ...
  describe("detectBuildTool", () => {
    ...
    it("should detect Webpack from dependencies", async () => {
      ...
      const result = await projectTypeAnalyzer.detectBuildTool(
        projectPath,
        dependencies,
      );
    ...
    it("should detect Webpack from config file", async () => {
      const dependencies = {};
      mockFileUtils.fileExists.mockResolvedValueOnce(true); // webpack.config.js
  ...
  describe("error handling", () => {
    ...
    it("should handle fileUtils errors gracefully when fileUtils is undefined", async () => {
      ...
      const result =
        await analyzerWithoutFileUtils.getProjectType("/test/path");
