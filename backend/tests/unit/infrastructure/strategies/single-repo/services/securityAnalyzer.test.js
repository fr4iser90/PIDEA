...
describe("SecurityAnalyzer", () => {
  ...
  describe("constructor", () => {
    ...
    it("should handle undefined logger gracefully", () => {
      const analyzerWithoutLogger = new SecurityAnalyzer(
        undefined,
        mockFileUtils,
      );
    ...
    it("should handle undefined fileUtils gracefully", () => {
      const analyzerWithoutFileUtils = new SecurityAnalyzer(
        mockLogger,
        undefined,
      );
  ...
  describe("hasAnyDependency", () => {
    it("should return true when dependency exists in dependencies", () => {
      ...
      const result = securityAnalyzer.hasAnyDependency(
        dependencies,
        targetDeps,
      );
  ...
  describe("integration with constants", () => {
    ...
    it("should use correct SECRETS_FILES constant", () => {
      expect(SECRETS_FILES).toEqual([".env", ".env.local", "secrets.json"]);
    });
