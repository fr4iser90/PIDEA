...
describe("IDEStarterFactory", () => {
  ...
  describe("createStarter", () => {
    ...
    it("should throw error for unsupported IDE type", () => {
      expect(() => factory.createStarter("unsupported")).toThrow(
  ...
  describe("registerStarter", () => {
    ...
    it("should throw error for invalid starter", () => {
      ...
      expect(() => factory.registerStarter("test", invalidStarter)).toThrow(
        "Starter must implement startIDE method",
      );
    });

    it("should throw error for null starter", () => {
      expect(() => factory.registerStarter("test", null)).toThrow(
        "Starter must implement startIDE method",
      );
    });
  });
  ...
  describe("startIDE", () => {
    ...
    it("should throw error if IDE already running on port", async () => {
      ...
      await expect(factory.startIDE("cursor", 9222)).rejects.toThrow(
  ...
  describe("stopIDE", () => {
    ...
    it("should throw error if no IDE running on port", async () => {
      await expect(factory.stopIDE(9222)).rejects.toThrow(
