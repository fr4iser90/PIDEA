...
describe("FrameworkRegistry - Domain Layer", () => {
  ...
  describe("Framework Registration", () => {
    it("should register a framework with valid metadata", async () => {
      ...
      await frameworkRegistry.registerFramework(
        frameworkName,
        config,
        "testing",
      );
      ...
      expect(frameworkRegistry.getFramework(frameworkName).name).toBe(
        frameworkName,
      );
    });
    ...
    it("should throw error for invalid framework configuration", async () => {
      ...
      await expect(
        frameworkRegistry.registerFramework(
          frameworkName,
          invalidConfig,
          "testing",
        ),
    ...
    it("should throw error for missing version", async () => {
      ...
      await expect(
        ...
        'Framework configuration must have a "version" property',
      );
    });
  ...
  describe("Framework Retrieval", () => {
    ...
    it("should get frameworks by category", () => {
      const testingFrameworks =
        frameworkRegistry.getFrameworksByCategory("testing");
      ...
      const developmentFrameworks =
        frameworkRegistry.getFrameworksByCategory("development");
  ...
  describe("IStandardRegistry Interface", () => {
    ...
    it("should import registry data", () => {
      const testData = {
        frameworks: [
          ["test-framework", { name: "test-framework", version: "1.0.0" }],
        ],
