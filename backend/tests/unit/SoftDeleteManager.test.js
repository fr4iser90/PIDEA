...
describe('SoftDeleteManager', () => {
  ...
  describe('softDelete', () => {
    it('should soft delete a record successfully', async () => {
      ...
      // Verify update call
      expect(mockDatabaseConnection.execute).toHaveBeenNthCalledWith(1,
      ...
      expect(mockDatabaseConnection.execute).toHaveBeenNthCalledWith(2,
    ...
    it('should throw error for invalid table name', async () => {
      ...
      await expect(softDeleteManager.softDelete(tableName, recordId))
  ...
  describe('recover', () => {
    ...
    it('should throw error for invalid recovery token', async () => {
      ...
      await expect(softDeleteManager.recover(tableName, recordId, recoveryToken))
  ...
  describe('permanentDelete', () => {
    it('should permanently delete a soft deleted record', async () => {
      ...
      const result = await softDeleteManager.permanentDelete(tableName, recordId);
    ...
    it('should throw error for non-soft-deleted record', async () => {
      ...
      await expect(softDeleteManager.permanentDelete(tableName, recordId))
  ...
  describe('getSoftDeletedRecords', () => {
    it('should retrieve soft deleted records', async () => {
      ...
      const records = await softDeleteManager.getSoftDeletedRecords(tableName, 10, 0);
  ...
  describe('getSoftDeleteMetadata', () => {
    it('should retrieve soft delete metadata', async () => {
      ...
      const metadata = await softDeleteManager.getSoftDeleteMetadata(tableName, recordId);
  ...
  describe('cleanupExpiredRecords', () => {
    it('should clean up expired records', async () => {
      ...
      const cleanedCount = await softDeleteManager.cleanupExpiredRecords(tableName, beforeDate);
