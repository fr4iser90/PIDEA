...
describe("IDE Chat Commands - Phase 1", () => {
  describe("Categories", () => {
    ...
    test("should include IDE in category descriptions", () => {
      ...
      expect(CATEGORY_DESCRIPTIONS[STANDARD_CATEGORIES.IDE]).toContain(
        "IDE integration",
      );
    });
  });
  ...
  describe("CommandRegistry", () => {
    test("should include IDE category in buildFromCategory", () => {
      const commandMap = CommandRegistry.buildFromCategory(
        "ide",
        "CreateChatCommand",
        {},
      );
    ...
    test("should list IDE commands by category", () => {
      const ideCommands = CommandRegistry.getByCategory(
  ...
  describe("HandlerRegistry", () => {
    test("should include IDE category in buildFromCategory", () => {
      const handlerMap = HandlerRegistry.buildFromCategory(
        "ide",
        "CreateChatHandler",
        {},
      );
    ...
    test("should list IDE handlers by category", () => {
      const ideHandlers = HandlerRegistry.getByCategory(
        STANDARD_CATEGORIES.IDE,
      );
