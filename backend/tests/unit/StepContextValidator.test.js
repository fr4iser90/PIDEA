  ...
  describe("validateStepContext", () => {
    describe("Common validation", () => {
      test("should validate required common fields", () => {
        ...
        const result = validator.validateStepContext(
          "ide",
      ...
      test("should fail on missing required fields", () => {
        ...
        expect(result.errors).toContain(
          "Required field 'projectId' is missing or null",
        );
      });
    ...
    describe("IDE step validation", () => {
      ...
      test("should fail on invalid IDE port", () => {
        ...
        expect(result.isValid).toBe(false);
        expect(result.errors).toContain(
          "IDE port must be between 1000 and 65535",
        );
      });
      ...
      test("should fail on invalid IDE type", () => {
        ...
        expect(result.isValid).toBe(false);
        expect(result.errors).toContain(
          "IDE type must be one of: cursor, vscode, windsurf, jetbrains",
        );
      });
    });
    ...
    describe("Terminal step validation", () => {
      ...
      test("should fail on command too long", () => {
        ...
        expect(result.isValid).toBe(false);
        expect(result.errors).toContain(
          "Command must be less than 1000 characters",
        );
      });
      ...
      test("should fail on invalid interpreter", () => {
        ...
        expect(result.isValid).toBe(false);
        expect(result.errors).toContain(
          "Interpreter must be one of the supported types",
        );
      });
    });
    ...
    describe("Git step validation", () => {
      ...
      test("should fail on invalid branch name", () => {
        ...
        expect(result.isValid).toBe(false);
        expect(result.errors).toContain(
          "Branch name must contain only alphanumeric characters, dots, underscores, slashes, and hyphens",
        );
      });
    ...
    describe("Analysis step validation", () => {
      ...
      test("should fail on invalid analysis type", () => {
        ...
        expect(result.isValid).toBe(false);
        expect(result.errors).toContain(
          "Analysis type must be one of: code-quality, security, performance, architecture, dependencies, coverage",
        );
      });
    });
    ...
    describe("Type validation", () => {
      test("should validate field types", () => {
        ...
        expect(result.isValid).toBe(false);
        expect(result.errors).toContain(
          "Field 'userId' should be string, got number",
        );
        expect(result.errors).toContain(
          "Field 'waitForResponse' should be boolean, got string",
        );
      });
    });
