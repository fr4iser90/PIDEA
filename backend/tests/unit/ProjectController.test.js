...
describe('ProjectController', () => {
  ...
  describe('createProject', () => {
    it('should create a project successfully', async () => {
      ...
      const createdProject = { id: '1', ...projectData, createdAt: new Date(), updatedAt: new Date() };
      mockProjectApplicationService.createProject.mockResolvedValue(createdProject);
      ...
      expect(mockProjectApplicationService.createProject).toHaveBeenCalledWith(projectData);
    ...
    it('should return validation errors for invalid data', async () => {
      ...
      expect(mockProjectApplicationService.createProject).not.toHaveBeenCalled();
    });
    ...
    it('should handle application service errors', async () => {
      ...
      mockProjectApplicationService.createProject.mockRejectedValue(new Error('Database error'));
  ...
  describe('getProject', () => {
    ...
    it('should handle application service errors', async () => {
      mockProjectApplicationService.getProject.mockRejectedValue(new Error('Database error'));
  ...
  describe('updateProject', () => {
    it('should update project successfully', async () => {
      ...
      mockProjectApplicationService.updateProject.mockResolvedValue(updatedProject);
      ...
      expect(mockProjectApplicationService.updateProject).toHaveBeenCalledWith('1', updates);
    ...
    it('should return validation errors for invalid updates', async () => {
      ...
      expect(res.status).toHaveBeenCalledWith(400);
      expect(res.json).toHaveBeenCalledWith({ error: expect.any(Array) });
      expect(mockProjectApplicationService.updateProject).not.toHaveBeenCalled();
    });
  ...
  describe('deleteProject', () => {
    it('should delete project successfully', async () => {
      ...
      expect(mockProjectApplicationService.deleteProject).toHaveBeenCalledWith('1');
  ...
  describe('listProjects', () => {
    ...
    it('should handle application service errors', async () => {
      mockProjectApplicationService.listProjects.mockRejectedValue(new Error('Database error'));
  ...
  describe('validateProjectData', () => {
    ...
    it('should reject invalid data types', () => {
      ...
      expect(result.errors).toContain('Workspace path is required and must be a string');
