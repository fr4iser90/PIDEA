  ...
  describe("Core Interfaces", () => {
    describe("IWorkflow", () => {
      ...
      it("should throw error when interface methods are not implemented", () => {
        ...
        expect(() => workflow.execute()).rejects.toThrow(
          "execute method must be implemented",
        );
        expect(() => workflow.validate()).rejects.toThrow(
          "validate method must be implemented",
        );
        expect(() => workflow.rollback()).rejects.toThrow(
          "rollback method must be implemented",
        );
        expect(() => workflow.getMetadata()).toThrow(
          "getMetadata method must be implemented",
        );
        expect(() => workflow.canExecute()).rejects.toThrow(
          "canExecute method must be implemented",
        );
        expect(() => workflow.getDependencies()).toThrow(
          "getDependencies method must be implemented",
        );
        expect(() => workflow.getSteps()).toThrow(
          "getSteps method must be implemented",
        );
      });
    });
  ...
  describe("Context Management", () => {
    describe("WorkflowState", () => {
      ...
      it("should transition to new states", () => {
        const state = new WorkflowState();
        const newState = state.transitionTo(WorkflowState.EXECUTING, {
          step: "test",
        });
  ...
  describe("Validation System", () => {
    describe("ValidationResult", () => {
      ...
      it("should merge results", () => {
        ...
        const result2 = ValidationResult.createWithWarning(
          "field2",
          "Warning 1",
        );
  ...
  describe("Exception Handling", () => {
    ...
    describe("ValidationException", () => {
      ...
      it("should create from validation result", () => {
        const result = ValidationResult.createWithError(
          "name",
          "Required field",
        );
