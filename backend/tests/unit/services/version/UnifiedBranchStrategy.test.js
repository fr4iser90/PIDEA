...
describe("UnifiedBranchStrategy", () => {
  ...
  describe("generateBranchName", () => {
    ...
    it("should handle missing task ID gracefully", () => {
      ...
      const branchName = strategy.generateBranchName(
        taskWithoutId,
        mockContext,
      );
  ...
  describe("validateBranchName", () => {
    it("should validate correct branch names", () => {
      const validBranchName =
        "task/test-task-123/test-feature-implementation/202412301200";
    ...
    it("should reject invalid branch names", () => {
      const invalidBranchName =
        "task/test-task-123/test feature with spaces/202412301200";
  ...
  describe("determineStrategy", () => {
    it("should determine correct strategy for feature tasks", () => {
      ...
      const strategyConfig = strategy.determineStrategy(
        featureTask,
        mockContext,
      );
