...
describe("AIVersionAnalysisService", () => {
  ...
  describe("analyzeVersionBump", () => {
    it("should analyze version bump and return recommendation", async () => {
      ...
      const result = await aiAnalysisService.analyzeVersionBump(
        changelog,
        projectPath,
        context,
      );
    ...
    it("should handle AI service failure gracefully", async () => {
      mockAIService.sendPrompt.mockRejectedValue(
    ...
    it("should use cached result for identical requests", async () => {
      ...
      // First call
      const result1 = await aiAnalysisService.analyzeVersionBump(
        changelog,
        projectPath,
        context,
      );
      ...
      const result2 = await aiAnalysisService.analyzeVersionBump(
        changelog,
        projectPath,
        context,
      );
  ...
  describe("prompt generation", () => {
    it("should generate proper analysis prompt", async () => {
      ...
      await aiAnalysisService.analyzeVersionBump(
        changelog,
        projectPath,
        context,
      );
