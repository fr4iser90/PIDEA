...
describe("AnalysisController", () => {
  ...
  describe("analyzeCodeQuality", () => {
    ...
    it("should analyze code quality successfully", async () => {
      ...
      expect(mockCodeQualityService.analyzeCodeQuality).toHaveBeenCalledWith(
        "/test/project",
        { includeTests: true },
      );
      expect(mockCodeQualityService.getQualityScore).toHaveBeenCalledWith(
        mockAnalysis,
      );
      expect(mockCodeQualityService.getQualityLevel).toHaveBeenCalledWith(85);
      expect(mockLogger.info).toHaveBeenCalledWith(
        "[AnalysisController] Code quality analysis requested for: /test/project",
      );
    ...
    it("should handle analysis errors", async () => {
      ...
      expect(mockLogger.error).toHaveBeenCalledWith(
        "[AnalysisController] Code quality analysis failed:",
        error,
      );
  ...
  describe("analyzeSecurity", () => {
    ...
    it("should analyze security successfully", async () => {
      ...
      expect(mockSecurityService.analyzeSecurity).toHaveBeenCalledWith(
        "/test/project",
        { scanDependencies: true },
      );
      expect(mockSecurityService.getSecurityScore).toHaveBeenCalledWith(
        mockAnalysis,
      );
      expect(mockSecurityService.getOverallRiskLevel).toHaveBeenCalledWith(
        mockAnalysis,
      );
      expect(
        mockSecurityService.hasCriticalVulnerabilities,
      ).toHaveBeenCalledWith(mockAnalysis);
      expect(mockSecurityService.getVulnerabilitySummary).toHaveBeenCalledWith(
        mockAnalysis,
      );
      expect(mockRes.json).toHaveBeenCalledWith({
        data: {
    ...
    it("should handle security analysis errors", async () => {
      ...
      expect(mockLogger.error).toHaveBeenCalledWith(
        "[AnalysisController] Security analysis failed:",
        error,
      );
      expect(mockRes.status).toHaveBeenCalledWith(500);
      expect(mockRes.json).toHaveBeenCalledWith({
  ...
  describe("analyzePerformance", () => {
    ...
    it("should analyze performance successfully", async () => {
      ...
      expect(mockPerformanceService.getPerformanceScore).toHaveBeenCalledWith(
        mockAnalysis,
      );
      expect(mockPerformanceService.getPerformanceLevel).toHaveBeenCalledWith(
        88,
      );
      expect(mockPerformanceService.getCriticalIssues).toHaveBeenCalledWith(
        mockAnalysis,
      );
      expect(mockPerformanceService.getPerformanceSummary).toHaveBeenCalledWith(
        mockAnalysis,
      );
      expect(mockRes.json).toHaveBeenCalledWith({
        data: {
    ...
    it("should handle performance analysis errors", async () => {
      ...
      expect(mockLogger.error).toHaveBeenCalledWith(
        "[AnalysisController] Performance analysis failed:",
        error,
      );
      expect(mockRes.status).toHaveBeenCalledWith(500);
      expect(mockRes.json).toHaveBeenCalledWith({
  ...
  describe("analyzeArchitecture", () => {
    ...
    it("should analyze architecture successfully", async () => {
      ...
      expect(mockArchitectureService.analyzeArchitecture).toHaveBeenCalledWith(
        "/test/project",
        { includeDependencies: true },
      );
      expect(mockArchitectureService.getArchitectureScore).toHaveBeenCalledWith(
        mockAnalysis,
      );
      expect(mockArchitectureService.getArchitectureLevel).toHaveBeenCalledWith(
        92,
      );
      expect(mockArchitectureService.isWellStructured).toHaveBeenCalledWith(
        mockAnalysis,
      );
      expect(
        mockArchitectureService.hasCircularDependencies,
      ).toHaveBeenCalledWith(mockAnalysis);
      expect(
        mockArchitectureService.getArchitectureSummary,
      ).toHaveBeenCalledWith(mockAnalysis);
      expect(mockRes.json).toHaveBeenCalledWith({
        data: {
          analysis: mockAnalysis,
    ...
    it("should handle architecture analysis errors", async () => {
      ...
      expect(mockLogger.error).toHaveBeenCalledWith(
        "[AnalysisController] Architecture analysis failed:",
        error,
      );
      expect(mockRes.status).toHaveBeenCalledWith(500);
      expect(mockRes.json).toHaveBeenCalledWith({
  ...
  describe("analyzeComprehensive", () => {
    ...
    it("should handle comprehensive analysis errors", async () => {
      ...
      expect(mockLogger.error).toHaveBeenCalledWith(
        "[AnalysisController] Comprehensive analysis failed:",
        error,
      );
      expect(mockRes.status).toHaveBeenCalledWith(500);
      expect(mockRes.json).toHaveBeenCalledWith({
  ...
  describe("getAnalysisHistory", () => {
    it("should get analysis history successfully", async () => {
      ...
      mockAnalysisOutputService.getAnalysisHistory.mockResolvedValue(
        mockHistory,
      );

      await controller.getAnalysisHistory(mockReq, mockRes);

      expect(mockAnalysisOutputService.getAnalysisHistory).toHaveBeenCalledWith(
        "project-123",
      );
      expect(mockRes.json).toHaveBeenCalledWith({
        data: mockHistory,
    ...
    it("should handle get analysis history errors", async () => {
      ...
      expect(mockLogger.error).toHaveBeenCalledWith(
        "[AnalysisController] Failed to get analysis history:",
        error,
      );
      expect(mockRes.status).toHaveBeenCalledWith(500);
      expect(mockRes.json).toHaveBeenCalledWith({
  ...
  describe("getAnalysisFile", () => {
    it("should get analysis file successfully", async () => {
      ...
      expect(mockAnalysisOutputService.getAnalysisFile).toHaveBeenCalledWith(
        "project-123",
        "report.md",
      );
      expect(mockRes.json).toHaveBeenCalledWith({
    ...
    it("should handle get analysis file errors with 404 status", async () => {
      ...
      expect(mockLogger.error).toHaveBeenCalledWith(
        "[AnalysisController] Failed to get analysis file:",
        error,
      );
  ...
  describe("getAnalysisFromDatabase", () => {
    it("should get analysis by project ID and type", async () => {
      ...
      const mockAnalyses = [{ id: 1, type: "code-quality", score: 85 }];

      mockAnalysisRepository.findByProjectIdAndType.mockResolvedValue(
        mockAnalyses,
      );
      ...
      expect(
        mockAnalysisRepository.findByProjectIdAndType,
      ).toHaveBeenCalledWith("project-123", "code-quality");
      expect(mockRes.json).toHaveBeenCalledWith({
        data: mockAnalyses,
      });
    });
    ...
    it("should get all analyses by project ID when no type specified", async () => {
      ...
      expect(mockAnalysisRepository.findByProjectId).toHaveBeenCalledWith(
        "project-123",
      );
      expect(mockRes.json).toHaveBeenCalledWith({
        data: mockAnalyses,
    ...
    it("should handle get analysis from database errors", async () => {
      ...
      expect(mockLogger.error).toHaveBeenCalledWith(
        "[AnalysisController] Failed to get analysis from database:",
        error,
      );
      expect(mockRes.status).toHaveBeenCalledWith(500);
      expect(mockRes.json).toHaveBeenCalledWith({
  ...
  describe("generateComprehensiveReport", () => {
    it("should generate comprehensive report successfully", async () => {
      ...
      mockAnalysisRepository.findByProjectId.mockResolvedValue(mockAnalyses);
      mockAnalysisOutputService.generateMarkdownReport.mockResolvedValue(
        mockReportResult,
      );
      ...
      expect(
        mockAnalysisOutputService.generateMarkdownReport,
    ...
    it("should handle generate comprehensive report errors", async () => {
      ...
      expect(mockLogger.error).toHaveBeenCalledWith(
        "[AnalysisController] Failed to generate comprehensive report:",
        error,
      );
      expect(mockRes.status).toHaveBeenCalledWith(500);
      expect(mockRes.json).toHaveBeenCalledWith({
  ...
  describe("analyzeTechStack", () => {
    ...
    it("should analyze tech stack successfully", async () => {
      ...
      global.application.techStackAnalyzer.analyzeTechStack.mockResolvedValue(
        mockAnalysis,
      );
      ...
      expect(
        global.application.techStackAnalyzer.analyzeTechStack,
      ).toHaveBeenCalledWith(
        expect.any(String),
    ...
    it("should handle analysis errors", async () => {
      ...
      global.application.techStackAnalyzer.analyzeTechStack.mockRejectedValue(
        error,
      );
      mockAnalysisRepository.findLatestByProjectId.mockResolvedValue(null);
  ...
  describe("analyzeRecommendations", () => {
    ...
    it("should generate recommendations successfully", async () => {
      const mockAnalysis = {
        ...
        insights: [{ type: "performance", message: "Consider code splitting" }],
      };

      global.application.recommendationsService.generateRecommendations.mockResolvedValue(
        mockAnalysis,
      );
      mockAnalysisRepository.findLatestByProjectId.mockResolvedValue(null);
      ...
      expect(
        global.application.recommendationsService.generateRecommendations,
      ).toHaveBeenCalledWith({});
      expect(mockRes.json).toHaveBeenCalledWith({
        data: {
          analysis: mockAnalysis,
    ...
    it("should handle analysis errors", async () => {
      ...
      global.application.recommendationsService.generateRecommendations.mockRejectedValue(
        error,
      );
      mockAnalysisRepository.findLatestByProjectId.mockResolvedValue(null);
      mockAnalysisRepository.findByProjectId.mockResolvedValue([]);
