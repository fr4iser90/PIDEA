...
describe("ContentLibraryController Prompts", () => {
      ...
      const mockPrompts = [
        {
          ...
          file: "frameworks/react-framework/prompts/component.md",
          type: "prompt",
        },
        {
          id: "testing",
          name: "testing",
          category: "testing",
          file: "frameworks/react-framework/prompts/testing.md",
          type: "prompt",
        },
      ];

      // Mock the scanDirectoryForPrompts method
      controller.scanDirectoryForPrompts = jest
        .fn()
      ...
      const mockPrompts = [
        {
          ...
          name: "component",
          category: "development",
          file: "prompts/development/component.md",
          type: "prompt",
        },
      ];
    ...
    it("should return prompt file content successfully", async () => {
      ...
      expect(fs.readFile).toHaveBeenCalledWith(
        expect.stringContaining(
          "content-library/prompts/development/component.md",
        ),
        "utf-8",
      );
      expect(mockRes.json).toHaveBeenCalledWith({
  ...
  describe("getPromptFileWithSubcategory", () => {
    it("should return prompt file with subcategory successfully", async () => {
      ...
      expect(fs.readFile).toHaveBeenCalledWith(
        expect.stringContaining(
          "content-library/prompts/development/react/component.md",
        ),
        "utf-8",
      );
      expect(mockRes.json).toHaveBeenCalledWith({
  ...
  describe("getFrameworkPromptFile", () => {
    it("should return framework prompt file successfully", async () => {
      ...
      expect(fs.readFile).toHaveBeenCalledWith(
        expect.stringContaining(
          "content-library/frameworks/react-framework/prompts/component.md",
        ),
        "utf-8",
      );
      expect(mockRes.json).toHaveBeenCalledWith({
