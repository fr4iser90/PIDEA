...
describe("AuthController", () => {
  ...
  describe("constructor", () => {
    it("should initialize with authApplicationService", () => {
      expect(controller.authApplicationService).toBe(
        mockAuthApplicationService,
      );
    });

    it("should throw error if authApplicationService is missing", () => {
      expect(() => new AuthController({})).toThrow(
  ...
  describe("register", () => {
    ...
    it("should register a new user successfully", async () => {
      ...
      expect(mockAuthApplicationService.register).toHaveBeenCalledWith(
        userData,
      );
  ...
  describe("login", () => {
    ...
    it("should login user successfully", async () => {
      ...
      expect(mockAuthApplicationService.login).toHaveBeenCalledWith(
        credentials,
      );
      expect(mockRes.json).toHaveBeenCalledWith({
        data: {
  ...
  describe("refresh", () => {
    ...
    it("should refresh token successfully", async () => {
      ...
      expect(mockAuthService.refreshUserSession).toHaveBeenCalledWith(
        "refresh-token-123",
      );
  ...
  describe("getProfile", () => {
    it("should return user profile when authenticated", async () => {
      ...
      expect(mockAuthApplicationService.getUserProfile).toHaveBeenCalledWith(
        "user-123",
      );
      expect(mockRes.json).toHaveBeenCalledWith({
        data: {
  ...
  describe("updateProfile", () => {
    ...
    it("should update email successfully", async () => {
      ...
      expect(mockAuthApplicationService.updateUserProfile).toHaveBeenCalledWith(
        "user-123",
        profileData,
      );
      expect(mockRes.json).toHaveBeenCalledWith({
  ...
  describe("getSessions", () => {
    it("should return user sessions when authenticated", async () => {
      ...
      expect(mockAuthApplicationService.getUserSessions).toHaveBeenCalledWith(
        "user-123",
      );
      expect(mockRes.json).toHaveBeenCalledWith({
        data: {
