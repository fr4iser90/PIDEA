...
describe("WebChatController", () => {
  ...
  describe("getPortChatHistory", () => {
    ...
    it("should get port chat history successfully", async () => {
      ...
      mockGetChatHistoryHandler.getPortChatHistory.mockResolvedValue(
        mockResult,
      );
  ...
  describe("getConnectionStatus", () => {
    it("should get connection status successfully", async () => {
      ...
      expect(mockCursorIDEService.getConnectionStatus).toHaveBeenCalledWith(
        "user-123",
      );
      expect(mockRes.json).toHaveBeenCalledWith({
        data: {
  ...
  describe("getQuickPrompts", () => {
    ...
    it("should handle get quick prompts errors", async () => {
      ...
      jest
        .spyOn(controller, "getQuickPromptsForUser")
  ...
  describe("getSettings", () => {
    ...
    it("should handle get settings errors", async () => {
      ...
      jest
        .spyOn(controller, "getUserSettings")
        .mockRejectedValue(new Error("Database error"));
  ...
  describe("updateSettings", () => {
    ...
    it("should handle update settings errors", async () => {
      ...
      jest
        .spyOn(controller, "updateUserSettings")
        .mockRejectedValue(new Error("Database error"));
