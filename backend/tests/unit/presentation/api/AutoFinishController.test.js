const AutoFinishController = require("@api/AutoFinishController");
...
describe("AutoFinishController", () => {
  ...
  describe("getSessionStatus", () => {
    ...
    it("should get session status successfully", async () => {
      ...
      expect(mockTaskSessionRepository.findById).toHaveBeenCalledWith(
        "session-123",
      );
  ...
  describe("getUserSessions", () => {
    ...
    it("should get user sessions successfully", async () => {
      const mockSessions = [
        {
          ...
          getSummary: jest
            .fn()
            .mockReturnValue({ id: "session-1", status: "completed" }),
        },
        {
          id: "session-2",
          getSummary: jest
            .fn()
            .mockReturnValue({ id: "session-2", status: "completed" }),
        },
      ];
      ...
      expect(mockTaskSessionRepository.findByUserId).toHaveBeenCalledWith(
        "user-123",
        {
          limit: 20,
          offset: 0,
  ...
  describe("getProjectSessions", () => {
    ...
    it("should get project sessions successfully", async () => {
      const mockSessions = [
        {
          ...
          getSummary: jest
            .fn()
            .mockReturnValue({ id: "session-1", status: "running" }),
        },
      ];
      ...
      expect(mockTaskSessionRepository.findByProjectId).toHaveBeenCalledWith(
        "project-123",
        {
          limit: 10,
          offset: 5,
  ...
  describe("cancelSession", () => {
    ...
    it("should cancel session successfully", async () => {
      ...
      expect(mockAutoFinishSystem.cancelSession).toHaveBeenCalledWith(
        "session-123",
      );
  ...
  describe("getSupportedPatterns", () => {
    it("should get supported patterns successfully", async () => {
      ...
      mockAutoFinishSystem.todoParser.getSupportedPatterns.mockReturnValue(
        mockPatterns,
      );
      ...
      expect(
        mockAutoFinishSystem.todoParser.getSupportedPatterns,
      ).toHaveBeenCalled();
  ...
  describe("getTaskTypeKeywords", () => {
    it("should get task type keywords successfully", async () => {
      ...
      mockAutoFinishSystem.todoParser.getTaskTypeKeywords.mockReturnValue(
        mockTaskTypes,
      );
      ...
      expect(
        mockAutoFinishSystem.todoParser.getTaskTypeKeywords,
      ).toHaveBeenCalled();
  ...
  describe("healthCheck", () => {
    ...
    it("should handle  error", async () => {
      ...
      const originalHealthCheck =
        errorController.healthCheck.bind(errorController);
