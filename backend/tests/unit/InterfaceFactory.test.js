...
describe("InterfaceFactory", () => {
  ...
  beforeEach(() => {
    ...
    interfaceManager.registerInterface("ide", TestInterface, {
      ideConfig: "value",
    });
  ...
  describe("Interface Creation", () => {
    ...
    test("should throw error when interface manager not available", async () => {
      const factoryWithoutManager = new InterfaceFactory({
        logger: mockLogger,
      });

      await expect(factoryWithoutManager.createInterface({})).rejects.toThrow(
        "InterfaceManager is required for interface creation",
      );
    });
    ...
    test("should execute creation hook after interface creation", async () => {
      ...
      const interfaceInstance =
        await interfaceFactory.createInterfaceByType("test");
  ...
  describe("Utility Methods", () => {
    ...
    test("should get default configuration", () => {
      ...
      const nonExistentConfig =
        interfaceFactory.getDefaultConfig("non-existent");
