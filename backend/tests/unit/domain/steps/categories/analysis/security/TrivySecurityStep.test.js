...
describe("TrivySecurityStep", () => {
  ...
  describe("constructor", () => {
    it("should initialize with correct properties", () => {
      ...
      expect(trivyStep.description).toBe(
  ...
  describe("execute", () => {
    ...
    it("should execute successfully with valid context", async () => {
      ...
      expect(mockLogger.info).toHaveBeenCalledWith(
        "🔒 Executing TrivySecurityStep...",
      );
      expect(mockLogger.info).toHaveBeenCalledWith(
        "✅ Trivy security analysis completed successfully",
      );
    });
    ...
    it("should handle missing project path", async () => {
      ...
      expect(mockLogger.error).toHaveBeenCalledWith(
        "❌ Trivy security analysis failed: Project path is required",
      );
    });
  ...
  describe("detectSecurityIssues", () => {
    ...
    it("should detect innerHTML assignment", () => {
      ...
      expect(result.vulnerabilities[0].message).toBe(
    ...
    it("should detect security best practices", () => {
      ...
      expect(result.bestPractices[0].message).toBe(
  ...
  describe("validateContext", () => {
    ...
    it("should throw for missing project path", () => {
      const context = {};
      expect(() => trivyStep.validateContext(context)).toThrow(
