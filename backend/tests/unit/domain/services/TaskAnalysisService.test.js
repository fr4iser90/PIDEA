...
describe("TaskAnalysisService", () => {
  ...
  describe("Project Analysis", () => {
    test("should perform full project analysis", async () => {
      ...
      const result = await taskAnalysisService.analyzeProject(
        projectPath,
        options,
      );

      expect(mockProjectAnalyzer.analyzeStructure).toHaveBeenCalledWith(
        projectPath,
      );
    ...
    test("should handle analysis errors gracefully", async () => {
      ...
      mockProjectAnalyzer.analyzeStructure.mockRejectedValue(
        new Error("Analysis failed"),
      );

      await expect(
        taskAnalysisService.analyzeProject(projectPath, options),
  ...
  describe("Code Quality Analysis", () => {
    test("should analyze code quality", async () => {
      ...
      mockProjectAnalyzer.analyzeCodeQuality.mockResolvedValue(
        mockQualityReport,
      );

      const result = await taskAnalysisService.analyzeCodeQuality(
        projectPath,
        options,
      );

      expect(mockProjectAnalyzer.analyzeCodeQuality).toHaveBeenCalledWith(
        projectPath,
      );
    ...
    test("should generate AI-powered quality improvements", async () => {
      ...
      const result =
        await taskAnalysisService.generateQualityImprovements(qualityReport);
  ...
  describe("Security Analysis", () => {
    test("should perform security analysis", async () => {
      ...
      mockAIService.performSecurityAnalysis.mockResolvedValue(
        mockSecurityReport,
      );

      const result = await taskAnalysisService.analyzeSecurity(
        projectPath,
        options,
      );
    ...
    test("should generate security fixes", async () => {
      ...
      const result =
        await taskAnalysisService.generateSecurityFixes(securityReport);
  ...
  describe("Performance Analysis", () => {
    test("should analyze performance", async () => {
      ...
      const result = await taskAnalysisService.analyzePerformance(
        projectPath,
        options,
      );
    ...
    test("should generate performance optimizations", async () => {
      const performanceReport = {
        bottlenecks: ["Large bundle size due to unused dependencies"],
      };
      ...
      const result =
        await taskAnalysisService.generatePerformanceOptimizations(
          performanceReport,
        );
  ...
  describe("Architecture Analysis", () => {
    test("should analyze architecture patterns", async () => {
      ...
      mockProjectAnalyzer.detectPatterns.mockResolvedValue(
        mockArchitectureReport,
      );

      const result = await taskAnalysisService.analyzeArchitecture(projectPath);

      expect(mockProjectAnalyzer.detectPatterns).toHaveBeenCalledWith(
        projectPath,
      );
    ...
    test("should generate architecture improvements", async () => {
      ...
      const result =
        await taskAnalysisService.generateArchitectureImprovements(
          architectureReport,
        );
  ...
  describe("Dependency Analysis", () => {
    test("should analyze project dependencies", async () => {
      ...
      mockProjectAnalyzer.identifyDependencies.mockResolvedValue(
        mockDependencyReport,
      );

      const result = await taskAnalysisService.analyzeDependencies(projectPath);

      expect(mockProjectAnalyzer.identifyDependencies).toHaveBeenCalledWith(
        projectPath,
      );
    ...
    test("should generate dependency recommendations", async () => {
      ...
      const result =
        await taskAnalysisService.generateDependencyRecommendations(
          dependencyReport,
        );
  ...
  describe("Comprehensive Analysis", () => {
    test("should perform comprehensive analysis with all aspects", async () => {
      ...
      const result = await taskAnalysisService.performComprehensiveAnalysis(
        projectPath,
        options,
      );
    ...
    test("should handle partial analysis failures gracefully", async () => {
      ...
      const mockStructure = { type: "nodejs", files: ["package.json"] };
      mockProjectAnalyzer.analyzeStructure.mockResolvedValue(mockStructure);
      mockProjectAnalyzer.analyzeCodeQuality.mockRejectedValue(
  ...
  describe("Analysis Caching", () => {
    test("should cache analysis results", async () => {
      ...
      const result1 = await taskAnalysisService.analyzeProject(
        projectPath,
        options,
      );

      // Second call should use cache
      const result2 = await taskAnalysisService.analyzeProject(
        projectPath,
        options,
      );
  ...
  describe("Error Handling", () => {
    test("should handle AI service errors gracefully", async () => {
      ...
      const mockStructure = { type: "nodejs", files: ["package.json"] };
      mockProjectAnalyzer.analyzeStructure.mockResolvedValue(mockStructure);
      mockAIService.generateInsights.mockRejectedValue(
