...
describe("TestMetadata Entity", () => {
  ...
  describe("Constructor", () => {
    ...
    it("should generate UUID if no id provided", () => {
      const metadata = TestMetadata.create(
        "/path/to/test.js",
        "test.js",
        "Test Suite",
      );
    ...
    it("should throw error for missing required fields", () => {
      expect(() => new TestMetadata()).toThrow(
        "File path is required for TestMetadata",
      );
      expect(
        () => new TestMetadata("id", null, "test.js", "Test Suite"),
      ).toThrow("File path is required for TestMetadata");
      expect(
        () => new TestMetadata("id", "/path/to/test.js", null, "Test Suite"),
      ).toThrow("File name is required for TestMetadata");
      expect(
        () => new TestMetadata("id", "/path/to/test.js", "test.js", null),
      ).toThrow("Test name is required for TestMetadata");
    });
    ...
    it("should throw error for negative values", () => {
      ...
      ).toThrow("Execution count cannot be negative");
      expect(
        () =>
          new TestMetadata(
            "id",
      ...
      ).toThrow("Success count cannot be negative");
      expect(
        () =>
          new TestMetadata(
            "id",
      ...
      ).toThrow("Failure count cannot be negative");
      expect(
        () =>
          new TestMetadata(
            "id",
      ...
      ).toThrow("Average duration cannot be negative");
    });
  });
  ...
  describe("Comparison Methods", () => {
    it("should check equality correctly", () => {
      const metadata1 = new TestMetadata(
        "same-id",
        "/path1",
        "test1.js",
        "Test 1",
      ...
      const metadata3 = new TestMetadata(
        "different-id",
        "/path1",
        "test1.js",
        "Test 1",
