...
describe('TestMetadata Entity', () => {
  ...
  describe('State Transitions', () => {
    ...
    it('should mark test as ', () => {
      testMetadata.markAs(75);
      expect(testMetadata.is).toBe(true);
      expect(testMetadata.Score).toBe(75);
    });
  ...
  describe('Health Score', () => {
    ...
    it('should reduce health score for  tests', () => {
      testMetadata._is = true;
      testMetadata._Score = 80;
      const healthScore = testMetadata.getHealthScore();
      expect(healthScore).toBeLessThan(100);
    });
