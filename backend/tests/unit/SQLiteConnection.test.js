...
describe("SQLiteConnection Unit Tests", () => {
  ...
  describe("Connection Management", () => {
    test("should connect successfully with memory database", async () => {
      ...
      expect(mockLogger.debug).toHaveBeenCalledWith(
        "🗄️ Connecting to SQLite database: :memory:",
      );
    });
    ...
    test("should connect successfully with file database", async () => {
      ...
      expect(mockLogger.debug).toHaveBeenCalledWith(
        "🗄️ Connecting to SQLite database: test.db",
      );
    });
    ...
    test("should handle connection errors gracefully", async () => {
      ...
      await expect(sqliteConnection.connect()).rejects.toThrow(
        "Connection failed",
      );
      expect(sqliteConnection.isConnected).toBe(false);
    });
    ...
    test("should handle disconnect errors gracefully", async () => {
      ...
      await expect(sqliteConnection.disconnect()).rejects.toThrow(
        "Close failed",
      );
    });
  });
  ...
  describe("Query Execution", () => {
    ...
    test("should execute INSERT statement successfully", async () => {
      ...
      const result = await sqliteConnection.execute(
    ...
    test("should throw error when not connected", async () => {
      ...
      await expect(
        sqliteConnection.query("SELECT * FROM test"),
    ...
    test("should handle execute errors gracefully", async () => {
      ...
      await expect(
        sqliteConnection.execute("INSERT INTO test VALUES (?)", ["test"]),
  ...
  describe("Table Verification", () => {
    ...
    test("should throw error when tables are missing", async () => {
      ...
      await expect(sqliteConnection.verifyTablesCreated()).rejects.toThrow(
  ...
  describe("Database Initialization", () => {
    ...
    test("should handle initialization errors gracefully", async () => {
      ...
      await expect(sqliteConnection.initializeDatabase()).rejects.toThrow(
  ...
  describe("Transaction Management", () => {
    ...
    test("should execute statements in transaction", async () => {
      ...
      await sqliteConnection.executeStatement(
        "BEGIN TRANSACTION",
    ...
    test("should handle transaction errors gracefully", async () => {
      ...
      await expect(
        sqliteConnection.executeStatement(
          "BEGIN TRANSACTION",
          "Starting transaction",
        ),
