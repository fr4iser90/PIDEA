...
describe("CodeQualityAnalysisOrchestrator", () => {
  ...
  describe("Step Loading", () => {
    it("should load code quality steps", async () => {
      ...
      expect(
        orchestrator.codeQualitySteps.LintingCodeQualityStep,
      ).toBeDefined();
      expect(
        orchestrator.codeQualitySteps.ComplexityCodeQualityStep,
      ).toBeDefined();
      expect(
        orchestrator.codeQualitySteps.CoverageCodeQualityStep,
      ).toBeDefined();
      expect(
        orchestrator.codeQualitySteps.DocumentationCodeQualityStep,
      ).toBeDefined();
    });
  });
  ...
  describe("Execution", () => {
    ...
    it("should handle step execution errors gracefully", async () => {
      ...
      expect(result.result.details.LintingCodeQualityStep.error).toBe(
        "Linting failed",
      );
    });
  });
