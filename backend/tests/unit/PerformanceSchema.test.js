...
describe('PerformanceSchema', () => {
  ...
  describe('constructor', () => {
    ...
    it('should initialize optimization rules', () => {
      expect(performanceSchema.optimizationRules.has('index_optimization')).toBe(true);
      expect(performanceSchema.optimizationRules.has('query_optimization')).toBe(true);
      expect(performanceSchema.optimizationRules.has('partition_optimization')).toBe(true);
      expect(performanceSchema.optimizationRules.has('materialized_view_optimization')).toBe(true);
    });
  });
  ...
  describe('initializeSchema', () => {
    ...
    it('should handle schema initialization errors', async () => {
      mockDatabaseConnection.execute.mockRejectedValue(new Error('Schema initialization failed'));

      await expect(performanceSchema.initializeSchema())
  ...
  describe('createPerformanceTables', () => {
    ...
    it('should handle table creation errors', async () => {
      mockDatabaseConnection.execute.mockRejectedValue(new Error('Table creation failed'));

      await expect(performanceSchema.createPerformanceTables())
  ...
  describe('createPerformanceIndexes', () => {
    ...
    it('should handle index creation errors', async () => {
      ...
      await expect(performanceSchema.createPerformanceIndexes())
  ...
  describe('createPerformanceViews', () => {
    ...
    it('should handle view creation errors', async () => {
      ...
      await expect(performanceSchema.createPerformanceViews())
  ...
  describe('createPerformanceFunctions', () => {
    ...
    it('should handle function creation errors', async () => {
      mockDatabaseConnection.execute.mockRejectedValue(new Error('Function creation failed'));

      await expect(performanceSchema.createPerformanceFunctions())
  ...
  describe('createPerformanceTriggers', () => {
    ...
    it('should handle trigger creation errors', async () => {
      mockDatabaseConnection.execute.mockRejectedValue(new Error('Trigger creation failed'));

      await expect(performanceSchema.createPerformanceTriggers())
  ...
  describe('checkSchemaCompatibility', () => {
    ...
    it('should handle compatibility check errors', async () => {
      mockDatabaseConnection.execute.mockRejectedValue(new Error('Compatibility check failed'));

      await expect(performanceSchema.checkSchemaCompatibility())
  ...
  describe('upgradeSchema', () => {
    ...
    it('should handle schema upgrade errors', async () => {
      mockDatabaseConnection.execute.mockRejectedValue(new Error('Schema upgrade failed'));

      await expect(performanceSchema.upgradeSchema())
        .rejects.toThrow('Schema upgrade failed');
    });
  });
  ...
  describe('validateSchema', () => {
    ...
    it('should detect schema validation errors', async () => {
      mockDatabaseConnection.execute.mockResolvedValue({
        rows: [
          { table_name: 'performance_metrics', status: 'missing' }
        ]
      });
