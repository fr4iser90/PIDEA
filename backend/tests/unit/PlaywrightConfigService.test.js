...
describe("PlaywrightConfigService", () => {
  ...
  describe("saveConfigurationToDatabase", () => {
    ...
    it("should throw error when project not found", async () => {
      ...
      await expect(
        service.saveConfigurationToDatabase(projectId, config),
    ...
    it("should throw error when project repository not available", async () => {
      ...
      await expect(
        serviceWithoutApp.saveConfigurationToDatabase("test", {}),
  ...
  describe("loadConfigurationFromDatabase", () => {
    ...
    it("should throw error when project not found", async () => {
      ...
      await expect(
        service.loadConfigurationFromDatabase(projectId),
