...
describe("TaskStatusSyncStep", () => {
  ...
  describe("Configuration", () => {
    it("should have correct configuration", () => {
      ...
      expect(config.description).toBe(
        "Synchronizes task statuses across systems",
      );
    ...
    it("should have correct validation rules", () => {
      ...
      expect(config.validation.requiredServices).toEqual([
        "taskRepository",
        "statusTransitionService",
        "eventBus",
      ]);
      expect(config.validation.supportedOperations).toEqual([
        "sync",
        "batch-sync",
        "validate",
        "rollback",
  ...
  describe("Context Validation", () => {
    ...
    it("should throw error for invalid context", () => {
      expect(() => step.validateContext(null)).toThrow(
        "Invalid context: getService method not available",
      );
      expect(() => step.validateContext({})).toThrow(
        "Invalid context: getService method not available",
      );
    });
  });
  ...
  describe("Service Retrieval", () => {
    it("should retrieve all required services", () => {
      ...
      expect(services.statusTransitionService).toBe(
        mockServices.statusTransitionService,
      );
    ...
    it("should throw error for missing TaskRepository", () => {
      ...
      expect(() => step.getRequiredServices(mockContext)).toThrow(
        "TaskRepository not available in context",
      );
    });
    ...
    it("should throw error for missing TaskStatusTransitionService", () => {
      ...
      expect(() => step.getRequiredServices(mockContext)).toThrow(
        "TaskStatusTransitionService not available in context",
      );
    });
    ...
    it("should throw error for missing EventBus", () => {
      ...
      expect(() => step.getRequiredServices(mockContext)).toThrow(
        "EventBus not available in context",
      );
    });
  });
  ...
  describe("Status Transition Validation", () => {
    it("should validate valid transitions", () => {
      expect(step.validateStatusTransition("pending", "in-progress")).toBe(
        true,
      );
      expect(step.validateStatusTransition("pending", "cancelled")).toBe(true);
      expect(step.validateStatusTransition("in-progress", "completed")).toBe(
        true,
      );
    ...
    it("should reject invalid transitions", () => {
      ...
      expect(step.validateStatusTransition("completed", "in-progress")).toBe(
        false,
      );
    });
  ...
  describe("Single Task Sync", () => {
    ...
    it("should sync single task successfully", async () => {
      ...
      const result = await step.syncSingleTask(
        mockContext,
        mockServices,
        options,
      );
      ...
      expect(mockServices.taskRepository.findById).toHaveBeenCalledWith(
        "test-task-1",
      );
      expect(mockServices.taskRepository.update).toHaveBeenCalledWith(
        "test-task-1",
        mockTask,
      );
    });
    ...
    it("should throw error for missing task ID", async () => {
      ...
      await expect(
        step.syncSingleTask(mockContext, mockServices, options),
      ).rejects.toThrow(
        "Task ID and target status are required for sync operation",
      );
    });
  ...
  describe("Batch Task Sync", () => {
    ...
    it("should sync multiple tasks successfully", async () => {
      ...
      const result = await step.syncBatchTasks(
        mockContext,
        mockServices,
        options,
      );
    ...
    it("should throw error for missing task IDs", async () => {
      ...
      await expect(
        step.syncBatchTasks(mockContext, mockServices, options),
  ...
  describe("Validation", () => {
    ...
    it("should validate multiple tasks successfully", async () => {
      ...
      const result = await step.validateSync(
        mockContext,
        mockServices,
        options,
      );
    ...
    it("should throw error for missing task IDs", async () => {
      ...
      await expect(
        step.validateSync(mockContext, mockServices, options),
  ...
  describe("Rollback", () => {
    ...
    it("should rollback multiple tasks successfully", async () => {
      ...
      const result = await step.rollbackSync(
        mockContext,
        mockServices,
        options,
      );
    ...
    it("should throw error for missing task IDs", async () => {
      ...
      await expect(
        step.rollbackSync(mockContext, mockServices, options),
  ...
  describe("Execute Method", () => {
    ...
    it("should throw error for unsupported operation", async () => {
      ...
      await expect(step.execute(mockContext, options)).rejects.toThrow(
