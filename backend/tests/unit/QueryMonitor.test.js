...
describe('QueryMonitor', () => {
  ...
  describe('beginQuery', () => {
    test('should begin query tracking', () => {
      ...
      const queryInfo = queryMonitor.beginQuery(queryId, query, params, databaseType);

      expect(queryInfo).toEqual(expect.objectContaining({
        queryId,
    ...
    test('should not begin tracking when disabled', () => {
      queryMonitor.enabled = false;
      const queryInfo = queryMonitor.beginQuery('test-query', 'SELECT * FROM users', [], 'postgresql');
  ...
  describe('endQuery', () => {
    test('should end query tracking successfully', () => {
      ...
      expect(performanceData).toEqual(expect.objectContaining({
        queryId,
        query: expect.any(String),
        params,
        databaseType,
    ...
    test('should handle missing query ID', () => {
      const performanceData = queryMonitor.endQuery('non-existent-id', {}, null);
  ...
  describe('trackExecutionPlan', () => {
    test('should track execution plan', () => {
      ...
      expect(trackSpy).toHaveBeenCalledWith('executionPlanTracked', { queryId, plan });
  ...
  describe('checkPerformanceIssues', () => {
    test('should detect slow query', () => {
      ...
      expect(issueSpy).toHaveBeenCalledWith('performanceIssue', expect.objectContaining({
        type: 'slow_query',
        severity: 'warning',
