  ...
  describe("validateBusinessRules", () => {
    ...
    test("should warn with timeout too high", () => {
      ...
      expect(result.warnings).toContain(
        "Analysis timeout is very high (over 30 minutes)",
      );
    });
    ...
    test("should fail validation with invalid export format", () => {
      ...
      expect(result.errors).toContain(
        "Invalid export format. Must be one of: json, markdown, html, pdf",
      );
    });
    ...
    test("should warn when no analysis types selected", () => {
      ...
      expect(result.isValid).toBe(true);
      expect(result.warnings).toContain(
        "No analysis types selected. At least one analysis type should be enabled.",
      );
    });
  });
  ...
  describe("getDescription", () => {
    test("should return description with all analysis types", () => {
      ...
      expect(description).toBe(
        "Advanced analysis with Standard, Layer, Logic validation for project: /test/project",
      );
    });
    ...
    test("should return description with partial analysis types", () => {
      ...
      expect(description).toBe(
        "Advanced analysis with Layer validation for project: /test/project",
      );
    });
  });
