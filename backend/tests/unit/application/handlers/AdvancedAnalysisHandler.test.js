...
describe("AdvancedAnalysisHandler", () => {
  ...
  describe("constructor", () => {
    ...
    test("should create default instances when dependencies not provided", () => {
      ...
      expect(defaultHandler.advancedAnalysisService).toBeInstanceOf(
  ...
  describe("handle", () => {
    test("should handle command successfully", async () => {
      ...
      mockAdvancedAnalysisService.performAdvancedAnalysis.mockResolvedValue(
        mockAnalysisResult.analysis,
      );
      mockAdvancedAnalysisService.generateAnalysisReport.mockReturnValue(
        mockAnalysisResult.report,
      );
    ...
    test("should handle command without report generation", async () => {
      ...
      expect(
        mockAdvancedAnalysisService.generateAnalysisReport,
    ...
    test("should handle project path validation errors", async () => {
      ...
      await expect(handler.handle(mockCommand)).rejects.toThrow(
  ...
  describe("validateProjectPath", () => {
    test("should validate existing directory", async () => {
      ...
      await expect(
        handler.validateProjectPath("/test/project"),
    ...
    test("should reject non-directory path", async () => {
      ...
      await expect(
        handler.validateProjectPath("/test/file.txt"),
    ...
    test("should reject non-existent path", async () => {
      ...
      await expect(
        handler.validateProjectPath("/nonexistent/path"),
  ...
  describe("performAdvancedAnalysis", () => {
    test("should perform advanced analysis successfully", async () => {
      ...
      const result = await handler.performAdvancedAnalysis(
        mockCommand,
        mockExecution,
      );
    ...
    test("should handle analysis service errors", async () => {
      ...
      await expect(
        handler.performAdvancedAnalysis(mockCommand, mockExecution),
  ...
  describe("publishAnalysisCompletedEvent", () => {
    test("should publish analysis completed event", async () => {
      ...
      await handler.publishAnalysisCompletedEvent(
        mockExecution,
        mockResult,
        mockCommand,
      );
  ...
  describe("updateExecutionProgress", () => {
    test("should update execution progress", async () => {
      ...
      await handler.updateExecutionProgress(
        mockExecution,
        50,
        "Processing analysis",
      );
