...
describe("ResponseQualityEngine", () => {
  ...
  describe("Constructor", () => {
    ...
    test("should have completion indicators", () => {
      expect(qualityEngine.completionIndicators.positive).toContain(
        "completed",
      );
      expect(qualityEngine.completionIndicators.negative).toContain(
        "incomplete",
      );
  ...
  describe("assessResponse", () => {
    ...
    test("should assess low-quality response", () => {
      const response =
        "I cannot complete this task due to an error. The system is broken.";
      const context = { userQuestion: "Create a simple function" };
  ...
  describe("assessCompleteness", () => {
    ...
    test("should detect explanations", () => {
      const response =
        "This is a very long explanation that provides detailed information about the implementation and how it works in different scenarios.";
      const context = {};
  ...
  describe("assessRelevance", () => {
    test("should detect question addressing", () => {
      const response =
        "To create a function, you need to use the function keyword.";
    ...
    test("should detect technical terms", () => {
      const response =
        "The function uses proper error handling and follows best practices.";
      const context = {};
    ...
    test("should detect action words", () => {
      const response =
        "You need to create a new function and implement the required logic.";
      const context = {};
    ...
    test("should detect context awareness", () => {
      const response =
        "Based on the previous discussion about functions, here is the implementation.";
  ...
  describe("detectLanguage", () => {
    ...
    test("should detect TypeScript", () => {
      const text =
        'interface User { name: string; } const user: User = { name: "test" };';
    ...
    test("should return text for unknown language", () => {
      const text =
        "This is plain text without any programming language patterns.";
  ...
  describe("generateSuggestions", () => {
    test("should generate suggestions for low completeness", () => {
      ...
      expect(result).toContain(
        "Add completion keywords to indicate task status",
      );
    ...
    test("should generate suggestions for low relevance", () => {
      ...
      expect(result).toContain(
        "Address the specific user question more directly",
      );
    ...
    test("should generate suggestions for errors", () => {
      ...
      expect(result).toContain(
        "Remove error keywords unless reporting actual errors",
      );
    });
  });
});
