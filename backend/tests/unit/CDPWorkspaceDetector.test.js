...
describe("CDPWorkspaceDetector", () => {
  ...
  describe("initialize", () => {
    it("should initialize successfully", async () => {
      ...
      expect(mockLogger.info).toHaveBeenCalledWith(
        "CDPWorkspaceDetector initialized successfully",
      );
    });
    ...
    it("should handle initialization failure", async () => {
      ...
      await expect(workspaceDetector.initialize()).rejects.toThrow(
    ...
    it("should not initialize twice", async () => {
      ...
      expect(mockLogger.debug).toHaveBeenCalledWith(
        "CDPWorkspaceDetector already initialized",
      );
    });
  });
  ...
  describe("detectWorkspace", () => {
    ...
    it("should detect workspace successfully", async () => {
      ...
      mockCDPManager.executeWorkspaceDetection.mockResolvedValue(
        mockWorkspaceInfo,
      );
      ...
      expect(mockCDPManager.cacheWorkspaceDetection).toHaveBeenCalledWith(
        9222,
        expect.any(Object),
        1000,
      );
  ...
  describe("detectWorkspacesForPorts", () => {
    ...
    it("should detect workspaces for multiple ports", async () => {
      ...
      const results = await workspaceDetector.detectWorkspacesForPorts([
        9222, 9223,
      ]);
  ...
  describe("getGitInformation", () => {
    ...
    it("should return Git information for valid repository", async () => {
      ...
      const result =
        await workspaceDetector.getGitInformation("/path/to/workspace");
  ...
  describe("getComprehensiveWorkspaceInfo", () => {
    ...
    it("should get comprehensive workspace info including Git data", async () => {
      ...
      const result =
        await workspaceDetector.getComprehensiveWorkspaceInfo(9222);
  ...
  describe("destroy", () => {
    it("should destroy successfully", async () => {
      ...
      expect(mockLogger.info).toHaveBeenCalledWith(
        "CDPWorkspaceDetector destroyed successfully",
      );
    });
