...
describe('PartitionManager', () => {
  ...
  describe('createPartition', () => {
    it('should create partition successfully', async () => {
      ...
      const result = await partitionManager.createPartition(table, partitionKey, strategy, options);
    ...
    it('should handle partition creation errors', async () => {
      ...
      mockDatabaseConnection.execute.mockRejectedValue(new Error('Partition creation failed'));

      await expect(partitionManager.createPartition(table, partitionKey, strategy, options))
  ...
  describe('createRangePartition', () => {
    it('should create range partition successfully', async () => {
      ...
      const result = await partitionManager.createRangePartition(table, partitionKey, rangeOptions);
  ...
  describe('createListPartition', () => {
    it('should create list partition successfully', async () => {
      ...
      const result = await partitionManager.createListPartition(table, partitionKey, listOptions);
  ...
  describe('dropPartition', () => {
    ...
    it('should handle non-existent partition', async () => {
      ...
      await expect(partitionManager.dropPartition(partitionName))
  ...
  describe('generatePartitionName', () => {
    it('should generate partition name correctly', () => {
      ...
      const partitionName = partitionManager.generatePartitionName(table, partitionKey);
  ...
  describe('generatePartitionSQL', () => {
    it('should generate range partition SQL', () => {
      ...
      const sql = partitionManager.generatePartitionSQL(table, partitionKey, strategy, options);
    ...
    it('should handle unknown strategy', () => {
      ...
      expect(() => partitionManager.generatePartitionSQL(table, partitionKey, strategy, options))
  ...
  describe('generateManagementActions', () => {
    it('should generate management actions', async () => {
      ...
      const result = await partitionManager.generateManagementActions(partitions);
  ...
  describe('generatePartitionRecommendations', () => {
    it('should generate partition recommendations', async () => {
      ...
      const result = await partitionManager.generatePartitionRecommendations(table, partitions);
  ...
  describe('getTableSize', () => {
    ...
    it('should handle errors gracefully', async () => {
      ...
      mockDatabaseConnection.execute.mockRejectedValue(new Error('Table not found'));
  ...
  describe('isTimeSeriesTable', () => {
    it('should identify time-series tables', () => {
      ...
      expect(partitionManager.isTimeSeriesTable('performance_metrics')).toBe(true);
