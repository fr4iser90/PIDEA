...
describe("FrameworkStepRegistry", () => {
  ...
  describe("Initialization", () => {
    ...
    it("should initialize successfully with valid parameters", async () => {
      ...
      expect(frameworkStepRegistry.frameworkBasePath).to.equal(
        frameworkBasePath,
      );
      expect(frameworkStepRegistry.stepRegistry).to.equal(mockStepRegistry);
      expect(
        frameworkStepRegistry.loadedFrameworks.has("refactoring_management"),
      ).to.be.true;
    });
  ...
  describe("Framework Discovery", () => {
    it("should discover valid framework directories", async () => {
      ...
      expect(
        frameworkStepRegistry.frameworkDirectories.has(
          "refactoring_management",
        ),
      ).to.be.true;
      expect(
        frameworkStepRegistry.frameworkDirectories.has("testing_management"),
      ).to.be.true;
    });
    ...
    it("should skip non-directory items", async () => {
      ...
      expect(frameworkStepRegistry.frameworkDirectories.size).to.equal(2);
      expect(frameworkStepRegistry.frameworkDirectories.has("README.md")).to.be
        .false;
    });
  ...
  describe("Step Loading", () => {
    it("should load framework steps successfully", async () => {
      ...
      expect(
        frameworkStepRegistry.frameworkSteps.has(
      ...
      expect(frameworkStepRegistry.loadedFrameworks.has(frameworkName)).to.be
        .true;
    });
  ...
  describe("Framework Management", () => {
    ...
    it("should get steps for specific framework", () => {
      const steps = frameworkStepRegistry.getFrameworkStepsByName(
        "refactoring_management",
      );
    ...
    it("should check if step is framework step", () => {
      expect(
        frameworkStepRegistry.isFrameworkStep("refactoring_management.step1"),
      ).to.be.true;
      expect(frameworkStepRegistry.isFrameworkStep("core.step")).to.be.false;
    });

    it("should get framework step info", () => {
      const stepInfo = frameworkStepRegistry.getFrameworkStepInfo(
        "refactoring_management.step1",
      );
    ...
    it("should return undefined for non-existent step", () => {
      const stepInfo =
        frameworkStepRegistry.getFrameworkStepInfo("non_existent.step");
  ...
  describe("Framework Reloading", () => {
    beforeEach(async () => {
      ...
      // Add existing step
      frameworkStepRegistry.frameworkSteps.set(
        "refactoring_management.old_step",
        {
          framework: "refactoring_management",
          name: "old_step",
    ...
    it("should reload framework successfully", async () => {
      ...
      expect(
        frameworkStepRegistry.frameworkSteps.has(
          "refactoring_management.reload_step",
        ),
      ).to.be.true;
    });
    ...
    it("should handle reload of non-existent framework", async () => {
      try {
        ...
        expect(error.message).to.include(
          "Framework non_existent_framework not found",
        );
      }
    });
