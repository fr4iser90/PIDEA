...
describe("FrameworkManager", () => {
  ...
  describe("Initialization", () => {
    ...
    it("should initialize successfully with dependencies", async () => {
      ...
      expect(frameworkManager.frameworkValidator).to.equal(
        mockFrameworkValidator,
      );
    });
  ...
  describe("Framework Activation", () => {
    ...
    it("should activate framework successfully", async () => {
      ...
      mockFrameworkLoader.getFramework
        .withArgs(frameworkName)
      ...
      mockFrameworkValidator.validateActivation.returns({
        valid: true,
        errors: [],
      });
  ...
  describe("Framework Deactivation", () => {
    ...
    it("should handle deactivation errors", async () => {
      ...
      sandbox
        .stub(frameworkManager, "performDeactivation")
        .rejects(new Error("Deactivation failed"));
  ...
  describe("Framework Management", () => {
    ...
    it("should get active framework by name", async () => {
      ...
      const activeFramework =
        frameworkManager.getActiveFramework(frameworkName);
    ...
    it("should get active frameworks by category", async () => {
      ...
      // Activate frameworks
      mockFrameworkLoader.getFramework
        .withArgs("refactoring_framework")
        .returns(refactoringFramework);
      mockFrameworkLoader.getFramework
        .withArgs("testing_framework")
        .returns(testingFramework);
      mockFrameworkValidator.validateFramework.returns({
        valid: true,
        errors: [],
      });
  ...
  describe("Error Handling", () => {
    ...
    it("should handle activation errors gracefully", async () => {
      ...
      mockFrameworkLoader.getFramework
        .withArgs(frameworkName)
        .returns(mockFramework);
      mockFrameworkValidator.validateFramework.rejects(
    ...
    it("should handle deactivation errors gracefully", async () => {
      ...
      sandbox
        .stub(frameworkManager, "performDeactivation")
        .rejects(new Error("Deactivation error"));
