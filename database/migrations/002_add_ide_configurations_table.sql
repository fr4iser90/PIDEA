...
CREATE TABLE IF NOT EXISTS ide_configurations (
    ...
    last_used TIMESTAMP WITH TIME ZONE, -- Last time this IDE was used
    ...
    startup_options JSONB, -- JSON with startup options
    metadata JSONB, -- JSON with additional IDE-specific settings
