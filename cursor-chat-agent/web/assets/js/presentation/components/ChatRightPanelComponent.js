    ...
    this.container.innerHTML = `
      <div class="chat-right-panel-content">
        <div class="panel-header">
          ...
          <button id="toggleChatPanelBtn" class="btn-icon" title="Panel ein-/ausblenden">◀</button>
        </div>
      ...
      <div class="chat-tab">
        ...
        <div class="quick-prompts">
          ...
          <div class="prompt-list">
            ...
            <button class="prompt-btn" data-prompt="Schreibe Tests für diesen Code">🧪 Tests</button>
            <button class="prompt-btn" data-prompt="Dokumentiere diesen Code">📚 Dokumentation</button>
          </div>
        </div>
      </div>
    `;
  ...
  updateFiles(files) {
    ...
    fileList.innerHTML = files.map(file => `
      <div class="file-item">
        ...
        <button class="file-remove-btn" data-file="${file.name}" title="Entfernen">×</button>
      </div>
    `).join('');
