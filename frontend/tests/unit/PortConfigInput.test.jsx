...
describe('PortConfigInput', () => {
  ...
  describe('Clear Functionality', () => {
    ...
    it('does not show clear button when validating', async () => {
      const mockValidatePort = jest.fn().mockImplementation(() => new Promise(resolve => setTimeout(resolve, 100)));
      ...
      // Should show loading spinner instead of clear button
      expect(screen.getByRole('button', { name: /clear port/i })).not.toBeInTheDocument();
