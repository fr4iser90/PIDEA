# IDE Migration Guide
## Overview
This guide provides step-by-step instructions for migrating from the  IDE structure to the new unified multi-IDE system in PIDEA.
## Migration Benefits
### Before Migration
...
The new IDE factory is automatically registered, but  services remain available:
```javascript
// Old way (still works)
