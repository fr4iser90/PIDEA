...
- Handler system should support  patterns through adapters
...
- Adapter pattern for backward compatibility with  handlers
...
- Use adapter pattern for  handler support
