...
- **Related Issues**: 149 failing tests, 32  tests, 438 complex tests, 5 slow tests
...
- [ ] `backend/scripts/test-correction/-test-migrator.js` -  test migration
...
- [ ] `backend/tests/performance/LoadTest.test.js` -  performance tests (after migration)
...
- [ ] Implement  test migration system
...
- [ ] Test data: Sample failing tests,  tests, complex tests
#### E2E Tests:
