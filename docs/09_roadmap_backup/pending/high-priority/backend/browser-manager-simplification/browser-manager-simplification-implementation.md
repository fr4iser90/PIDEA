...
- [ ] `docs/09_roadmap/pending/high/backend/browser-manager-simplification/browser-manager-simplification-index.md` - Master index file
...
- **source_path**: 'docs/09_roadmap/pending/high/backend/browser-manager-simplification/browser-manager-simplification-implementation.md'
- **category**: 'backend'
...
INSERT INTO tasks (
  ...
  'docs/09_roadmap/pending/high/backend/browser-manager-simplification/browser-manager-simplification-implementation.md', -- Main implementation file
