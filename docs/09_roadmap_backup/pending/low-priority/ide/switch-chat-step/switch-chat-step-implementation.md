# Switch Chat Step Implementation
...
- [ ] `docs/09_roadmap/pending/low/ide/switch-chat-step/switch-chat-step-index.md` - Master index file
...
- **source_path**: 'docs/09_roadmap/pending/low/ide/switch-chat-step/switch-chat-step-implementation.md'
- **category**: 'ide'
